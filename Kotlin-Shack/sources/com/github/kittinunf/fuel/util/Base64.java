...
public class Base64 {
    ...
    public static String encodeToString(byte[] input, int flags) {
        try {
            return new String(encode(input, flags), StandardStringDigester.DIGEST_CHARSET);
    ...
    public static String encodeToString(byte[] input, int offset, int len, int flags) {
        try {
            return new String(encode(input, offset, len, flags), StandardStringDigester.DIGEST_CHARSET);
        } catch (UnsupportedEncodingException e) {
            throw new AssertionError(e);
        }
    }
    ...
    static class Decoder extends Coder {
        ...
        @Override // com.github.kittinunf.fuel.util.Base64.Coder
        ...
        */
        public boolean process(byte[] r12, int r13, int r14, boolean r15) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.kittinunf.fuel.util.Base64.Decoder.process(byte[], int, int, boolean):boolean");
        }
    }
    ...
    static class Encoder extends Coder {
        ...
        public boolean process(byte[] input, int offset, int len, boolean finish) {
            ...
            switch (this.tailLen) {
                ...
                case 2:
                    if (offset + 1 <= len2) {
                        int i3 = ((this.tail[0] & 255) << 16) | ((this.tail[1] & 255) << 8);
                        int p8 = offset + 1;
                        int p9 = input[offset];
                        v = i3 | (p9 & 255);
                        this.tailLen = 0;
