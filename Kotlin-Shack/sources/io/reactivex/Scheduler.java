        ...
        final class PeriodicTask implements Runnable, SchedulerRunnableIntrospection {
            ...
            public void run() {
                ...
                if (!this.sd.isDisposed()) {
                    ...
                    if (nowNanoseconds + Scheduler.CLOCK_DRIFT_TOLERANCE_NANOSECONDS < this.lastNowNanoseconds || nowNanoseconds >= this.lastNowNanoseconds + this.periodInNanoseconds + Scheduler.CLOCK_DRIFT_TOLERANCE_NANOSECONDS) {
                        long nextTick2 = nowNanoseconds + this.periodInNanoseconds;
                        long j = this.periodInNanoseconds;
                        long j2 = this.count + 1;
                        this.count = j2;
                        this.startInNanoseconds = nextTick2 - (j * j2);
                        nextTick = nextTick2;
                    } else {
