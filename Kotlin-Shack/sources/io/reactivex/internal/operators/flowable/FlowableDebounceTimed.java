...
public final class FlowableDebounceTimed<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class DebounceTimedSubscriber<T> extends AtomicLong implements FlowableSubscriber<T>, Subscription {
        ...
        public void onNext(T t) {
            ...
            DebounceEmitter<T> de2 = new DebounceEmitter<>(t, idx, this);
            if (this.timer.replace(de2)) {
                de2.setResource(this.worker.schedule(de2, this.timeout, this.unit));
            }
        }
        ...
        public void onComplete() {
            ...
            if (!DisposableHelper.isDisposed(d)) {
                DebounceEmitter<T> de2 = (DebounceEmitter) d;
                if (de2 != null) {
                    de2.emit();
                }
