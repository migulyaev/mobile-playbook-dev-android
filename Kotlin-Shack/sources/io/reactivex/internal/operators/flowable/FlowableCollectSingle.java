...
public final class FlowableCollectSingle<T, U> extends Single<U> implements FuseToFlowable<U> {
    ...
    protected void subscribeActual(SingleObserver<? super U> s) {
        try {
            this.source.subscribe((FlowableSubscriber) new CollectSubscriber(s, ObjectHelper.requireNonNull(this.initialSupplier.call(), "The initialSupplier returned a null value"), this.collector));
        } catch (Throwable e) {
