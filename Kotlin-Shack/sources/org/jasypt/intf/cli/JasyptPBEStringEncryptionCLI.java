...
public final class JasyptPBEStringEncryptionCLI {
    static /* synthetic */ Class class$org$jasypt$intf$cli$JasyptPBEStringEncryptionCLI;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String result2 = service2.encrypt(input2, argumentValues2.getProperty("password"), null, null, argumentValues2.getProperty("algorithm"), null, null, argumentValues2.getProperty("keyObtentionIterations"), null, null, argumentValues2.getProperty("saltGeneratorClassName"), null, null, argumentValues2.getProperty("providerName"), null, null, argumentValues2.getProperty("providerClassName"), null, null, argumentValues2.getProperty("stringOutputType"), null, null);
