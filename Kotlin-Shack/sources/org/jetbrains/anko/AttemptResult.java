...
public final /* data */ class AttemptResult<T> {
    ...
    @PublishedApi
    public AttemptResult(@Nullable T t, @Nullable Throwable error) {
        this.value = t;
        this.error = error;
    }
    ...
    public final <R> AttemptResult<R> then(@NotNull Function1<? super T, ? extends R> f) {
        ...
        if (getError() != null) {
            if (this == 0) {
                throw new TypeCastException("null cannot be cast to non-null type org.jetbrains.anko.AttemptResult<R>");
            }
            return this;
        }
        Object obj = null;
