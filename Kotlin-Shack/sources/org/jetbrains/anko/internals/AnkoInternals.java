...
public final class AnkoInternals {
    ...
    @NotNull
    public final <T> AnkoContext<T> createAnkoContext(T t, @NotNull Context ctx, @NotNull Function1<? super AnkoContext<? extends T>, Unit> init, boolean setContentView) {
        Intrinsics.checkParameterIsNotNull(ctx, "ctx");
        Intrinsics.checkParameterIsNotNull(init, "init");
    ...
    @JvmStatic
    public static final boolean testConfiguration(@NotNull Context ctx, @Nullable ScreenSize screenSize, @Nullable ClosedRange<Integer> density, @Nullable String language, @Nullable Orientation orientation, @Nullable Boolean r27, @Nullable Integer fromSdk, @Nullable Integer sdk, @Nullable UiMode uiMode, @Nullable Boolean nightMode, @Nullable Boolean rightToLeft, @Nullable Integer smallestWidth) {
        ...
        if (uiMode != null) {
            ...
            } else if (i == InternalConfiguration.INSTANCE.getUI_MODE_TYPE_WATCH() && (!Intrinsics.areEqual(uiMode, UiMode.WATCH))) {
                return false;
            }
        }
        if (nightMode != null) {
        ...
        if (smallestWidth != null) {
            ...
            if (config.smallestScreenWidthDp == 0) {
                if (!Intrinsics.areEqual(smallestWidth, Integer.valueOf((int) z))) {
                    return z;
                }
                return true;
            }
            if (Intrinsics.compare(config.smallestScreenWidthDp, smallestWidth.intValue()) < 0) {
                return z;
            }
            return true;
        }
