...
public final class AsyncKt {
    ...
    public static final void runOnUiThread(@NotNull final Context receiver, @NotNull final Function1<? super Context, Unit> f) {
    ...
    public static final <T> void onComplete(@NotNull AnkoAsyncContext<T> receiver, @NotNull final Function1<? super T, Unit> f) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(f, "f");
    ...
    public static final <T> boolean uiThread(@NotNull AnkoAsyncContext<T> receiver, @NotNull final Function1<? super T, Unit> f) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(f, "f");
        final Object ref = receiver.getWeakRef().get();
        if (ref == null) {
    ...
    public static final <T extends Activity> boolean activityUiThread(@NotNull AnkoAsyncContext<T> receiver, @NotNull final Function1<? super T, Unit> f) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(f, "f");
    ...
    public static final <T extends Activity> boolean activityUiThreadWithContext(@NotNull AnkoAsyncContext<T> receiver, @NotNull final Function2<? super Context, ? super T, Unit> f) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(f, "f");
        final Activity activity = receiver.getWeakRef().get();
        if (activity == null || activity.isFinishing()) {
    ...
    public static final <T extends Activity> boolean activityContextUiThread(@NotNull AnkoAsyncContext<AnkoContext<T>> receiver, @NotNull final Function1<? super T, Unit> f) {
    ...
    public static final <T extends Activity> boolean activityContextUiThreadWithContext(@NotNull AnkoAsyncContext<AnkoContext<T>> receiver, @NotNull final Function2<? super Context, ? super T, Unit> f) {
        final Activity activity;
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(f, "f");
        AnkoContext<T> ankoContext = receiver.getWeakRef().get();
        ...
        activity.runOnUiThread(new Runnable() { // from class: org.jetbrains.anko.AsyncKt$activityUiThreadWithContext$2
            @Override // java.lang.Runnable
            public final void run() {
                Function2.this.invoke(activity, activity);
            }
        });
        return true;
    }

    public static final <T extends Fragment> boolean fragmentUiThread(@NotNull AnkoAsyncContext<T> receiver, @NotNull final Function1<? super T, Unit> f) {
        Activity activity;
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(f, "f");
    ...
    public static final <T extends Fragment> boolean fragmentUiThreadWithContext(@NotNull AnkoAsyncContext<T> receiver, @NotNull final Function2<? super Context, ? super T, Unit> f) {
        final Activity activity;
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(f, "f");
        final Fragment fragment = receiver.getWeakRef().get();
    ...
    @NotNull
    public static final <T> Future<Unit> doAsync(T t, @Nullable final Function1<? super Throwable, Unit> function1, @NotNull final Function1<? super AnkoAsyncContext<T>, Unit> task) {
    ...
    @NotNull
    public static final <T> Future<Unit> doAsync(T t, @Nullable final Function1<? super Throwable, Unit> function1, @NotNull ExecutorService executorService, @NotNull final Function1<? super AnkoAsyncContext<T>, Unit> task) {
    ...
    @NotNull
    public static final <T, R> Future<R> doAsyncResult(T t, @Nullable final Function1<? super Throwable, Unit> function1, @NotNull final Function1<? super AnkoAsyncContext<T>, ? extends R> task) {
        Intrinsics.checkParameterIsNotNull(task, "task");
    ...
    @NotNull
    public static final <T, R> Future<R> doAsyncResult(T t, @Nullable final Function1<? super Throwable, Unit> function1, @NotNull ExecutorService executorService, @NotNull final Function1<? super AnkoAsyncContext<T>, ? extends R> task) {
        Intrinsics.checkParameterIsNotNull(executorService, "executorService");
        Intrinsics.checkParameterIsNotNull(task, "task");
        final AnkoAsyncContext ankoAsyncContext = new AnkoAsyncContext(new WeakReference(t));
