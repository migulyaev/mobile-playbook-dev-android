            ...
            if (nodesFrom == null && nodesTo == null) {
                ...
                if (nodesFrom != null) {
                    ...
                    if (nodesTo != null) {
                        ...
                        toType = toType2;
                        ofObject = PropertyValuesHolder.ofObject(propertyName, evaluator, nodesFrom, nodesTo);
                    } else {
                        toType = toType2;
                        ofObject = PropertyValuesHolder.ofObject(propertyName, evaluator, nodesFrom);
                    }
