...
public final class SlidingWindowKt {
    ...
    public static final <T> Iterator<List<T>> windowedIterator(@NotNull Iterator<? extends T> iterator, int size, int step, boolean partialWindows, boolean reuseBuffer) {
        ...
        return !iterator.hasNext() ? EmptyIterator.INSTANCE : SequenceBuilderKt.buildIterator(new SlidingWindowKt$windowedIterator$1(step, size, iterator, reuseBuffer, partialWindows, null));
    }
}
