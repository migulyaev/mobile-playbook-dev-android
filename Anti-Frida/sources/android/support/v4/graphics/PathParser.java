...
public class PathParser {
    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            for (int k2 = 0; k2 < val.length; k2 = k + incr) {
                switch (cmd) {
                    case 'A':
                        k = k2;
                    ...
                    case 'S':
                        ...
                        if (previousCmd2 == 'c' || previousCmd2 == 's' || previousCmd2 == 'C' || previousCmd2 == 'S') {
                            reflectiveCtrlPointX = (currentX2 * 2.0f) - ctrlPointX4;
                            reflectiveCtrlPointY = (currentY2 * 2.0f) - ctrlPointY4;
                        } else {
                    ...
                    case 'T':
                        ...
                        if (previousCmd2 == 'q' || previousCmd2 == 't' || previousCmd2 == 'Q' || previousCmd2 == 'T') {
                            reflectiveCtrlPointX3 = (currentX2 * 2.0f) - ctrlPointX4;
                            reflectiveCtrlPointY3 = (currentY2 * 2.0f) - ctrlPointY4;
                        }
                    ...
                    case 't':
                        ...
                        float ctrlPointX5 = currentX2 + reflectiveCtrlPointX4;
        ...
        /* JADX INFO: Multiple debug info for r2v4 double: [D('alpha' double), D('q2y' double)] */
