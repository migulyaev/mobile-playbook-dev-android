...
public final class LocalBroadcastManager {
    ...
    /* JADX INFO: Multiple debug info for r11v5 java.util.ArrayList<android.support.v4.content.LocalBroadcastManager$ReceiverRecord>: [D('type' java.lang.String), D('receivers' java.util.ArrayList<android.support.v4.content.LocalBroadcastManager$ReceiverRecord>)] */
        ...
        synchronized (this.mReceivers) {
            ...
            if (entries2 != null) {
                ...
                while (i2 < entries2.size()) {
                    ReceiverRecord receiver = entries2.get(i2);
                    if (debug) {
