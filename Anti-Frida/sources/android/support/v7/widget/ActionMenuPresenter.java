...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    /* JADX INFO: Multiple debug info for r3v7 int: [D('v' android.view.View), D('groupId' int)] */
    /* JADX INFO: Multiple debug info for r9v9 boolean: [D('v' android.view.View), D('isAction' boolean)] */
