...
public class LinearLayoutCompat extends ViewGroup {
    ...
    /* JADX INFO: Multiple debug info for r4v14 android.view.View: [D('delta' int), D('child' android.view.View)] */
    /* JADX INFO: Multiple debug info for r6v3 int: [D('alternativeMaxWidth' int), D('weightedMaxWidth' int)] */
    ...
    /* JADX INFO: Multiple debug info for r0v25 int: [D('ascent' int), D('maxHeight' int)] */
    /* JADX INFO: Multiple debug info for r0v34 android.view.View: [D('child' android.view.View), D('widthSize' int)] */
    /* JADX INFO: Multiple debug info for r0v43 int: [D('i' int), D('totalLength' int)] */
    /* JADX INFO: Multiple debug info for r0v73 int: [D('i' int), D('totalLength' int)] */
    /* JADX INFO: Multiple debug info for r14v1 boolean: [D('useLargestChild' boolean), D('skippedMeasure' boolean)] */
    /* JADX INFO: Multiple debug info for r1v73 int: [D('childWidth' int), D('largestChildWidth' int)] */
    /* JADX INFO: Multiple debug info for r2v3 int: [D('weightedMaxHeight' int), D('largestChildWidth' int)] */
    /* JADX INFO: Multiple debug info for r5v9 android.view.View: [D('totalWeight' float), D('child' android.view.View)] */
        ...
        while (true) {
            ...
            if (i2 < count) {
                ...
                if (child == null) {
                    ...
                    int gravity2 = GravityCompat.getAbsoluteGravity(gravity, ViewCompat.getLayoutDirection(this)) & 7;
                    majorGravity = majorGravity2;
                    if (gravity2 != 1) {
    ...
    /* JADX INFO: Multiple debug info for r3v2 int: [D('i' int), D('childLeft' int)] */
