...
public class Toolbar extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (i2 < childCount2) {
            ...
            if (((LayoutParams) child.getLayoutParams()).mViewType != 0) {
                ...
                childState = Math.max(childState, child.getMeasuredHeight() + getVerticalMargins(child));
    ...
    /* JADX INFO: Multiple debug info for r1v20 int: [D('titleRight' int), D('right' int)] */
    /* JADX INFO: Multiple debug info for r3v20 android.support.v7.widget.Toolbar$LayoutParams: [D('topChild' android.view.View), D('bottomlp' android.support.v7.widget.Toolbar$LayoutParams)] */
    /* JADX WARN: Code restructure failed: missing block: B:53:0x015c, code lost:
        if (r40.mTitleTextView.getMeasuredWidth() > 0) goto L_0x016b;
     */
