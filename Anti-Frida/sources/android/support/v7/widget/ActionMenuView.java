...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    /* JADX INFO: Multiple debug info for r3v6 long: [D('smallestItemsAt' long), D('maxChildHeight' int)] */
    /* JADX INFO: Multiple debug info for r7v20 android.support.v7.widget.ActionMenuView$LayoutParams: [D('needsExpansion' boolean), D('lp' android.support.v7.widget.ActionMenuView$LayoutParams)] */
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* JADX INFO: Multiple debug info for r6v7 int: [D('b' int), D('midVertical' int)] */
