...
public class Analyzer {
    ...
    private static int getMaxDimensionTraversal(ConstraintWidget widget, int orientation, boolean topLeftFlow, int depth) {
        ...
        while (it2.hasNext()) {
            dimensionPost3 = Math.max(dimensionPost3, getMaxDimensionTraversal(((ResolutionAnchor) ((ResolutionNode) it2.next())).myAnchor.mOwner, orientation, topLeftFlow, postTemp3 + downDepth));
            it2 = it2;
            endOffset = endOffset;
        }
        if (hasBaseline) {
