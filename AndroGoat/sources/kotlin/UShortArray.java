...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static final /* synthetic */ UShortArray m301boximpl(short[] v) {
        Intrinsics.checkParameterIsNotNull(v, "v");
        return new UShortArray(v);
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m306equalsimpl(short[] sArr, Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual(sArr, ((UShortArray) obj).getStorage());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m307equalsimpl0(short[] sArr, short[] sArr2) {
        return Intrinsics.areEqual(sArr, sArr2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m310hashCodeimpl(short[] sArr) {
        if (sArr != null) {
    ...
    public static String m314toStringimpl(short[] sArr) {
    ...
    public boolean m315addxj2QHRw(short s) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean m316containsxj2QHRw(short s) {
        return m304containsxj2QHRw(this.storage, s);
    }

    @Override // java.util.Collection
    public boolean containsAll(Collection<? extends Object> collection) {
        return m305containsAllimpl(this.storage, collection);
    }

    @Override // java.util.Collection
    public boolean equals(Object other) {
        return m306equalsimpl(this.storage, other);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m316containsxj2QHRw(((UShort) obj).getData());
        }
        return false;
    }
    ...
    public static short[] m303constructorimpl(short[] storage) {
        Intrinsics.checkParameterIsNotNull(storage, "storage");
        return storage;
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static short[] m302constructorimpl(int size) {
        return m303constructorimpl(new short[size]);
    }

    /* renamed from: get-impl, reason: not valid java name */
    public static final short m308getimpl(short[] $this, int index) {
        return UShort.m259constructorimpl($this[index]);
    }

    /* renamed from: set-01HTLdE, reason: not valid java name */
    public static final void m313set01HTLdE(short[] $this, int index, short value) {
        $this[index] = value;
    }

    /* renamed from: getSize-impl, reason: not valid java name */
    public static int m309getSizeimpl(short[] $this) {
        return $this.length;
    }

    /* renamed from: iterator-impl, reason: not valid java name */
    public static UShortIterator m312iteratorimpl(short[] $this) {
    ...
    public static final class Iterator extends UShortIterator {
        ...
        public short nextUShort() {
            ...
            this.index = i + 1;
            return UShort.m259constructorimpl(sArr[i]);
        }
    }

    /* renamed from: contains-xj2QHRw, reason: not valid java name */
    public static boolean m304containsxj2QHRw(short[] $this, short element) {
        return ArraysKt.contains($this, element);
    }

    /* renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m305containsAllimpl(short[] $this, Collection<UShort> elements) {
    ...
    public static boolean m311isEmptyimpl(short[] $this) {
