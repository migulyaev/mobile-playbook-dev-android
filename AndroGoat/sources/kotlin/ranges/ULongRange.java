...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(ULong uLong) {
        return m919containsVKZWuLQ(uLong.getData());
    }

    @Override // kotlin.ranges.ClosedRange
    public ULong getStart() {
        return ULong.m156boximpl(getFirst());
    }

    @Override // kotlin.ranges.ClosedRange
    public ULong getEndInclusive() {
        return ULong.m156boximpl(getLast());
    }

    /* renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m919containsVKZWuLQ(long value) {
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m162constructorimpl(getLast() ^ ULong.m162constructorimpl(getLast() >>> 32))) + (((int) ULong.m162constructorimpl(getFirst() ^ ULong.m162constructorimpl(getFirst() >>> 32))) * 31);
    }

    @Override // kotlin.ranges.ULongProgression
    public String toString() {
        return ULong.m199toStringimpl(getFirst()) + ".." + ULong.m199toStringimpl(getLast());
    }
