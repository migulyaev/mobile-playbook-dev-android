...
public final class URandomKt {
    ...
    public static final int m913nextUIntqCasIEU(Random nextUInt, int until) {
        Intrinsics.checkParameterIsNotNull(nextUInt, "$this$nextUInt");
        return m912nextUInta8DCA5k(nextUInt, 0, until);
    }

    /* renamed from: nextUInt-a8DCA5k, reason: not valid java name */
    public static final int m912nextUInta8DCA5k(Random nextUInt, int from, int until) {
        Intrinsics.checkParameterIsNotNull(nextUInt, "$this$nextUInt");
        m907checkUIntRangeBoundsJ1ME1BU(from, until);
        ...
        return UInt.m93constructorimpl(signedResult);
    }
    ...
    public static final long m914nextULongV1Xi4fY(Random nextULong, long until) {
        Intrinsics.checkParameterIsNotNull(nextULong, "$this$nextULong");
        return m915nextULongjmpaWc(nextULong, 0L, until);
    }

    /* renamed from: nextULong-jmpaW-c, reason: not valid java name */
    public static final long m915nextULongjmpaWc(Random nextULong, long from, long until) {
        Intrinsics.checkParameterIsNotNull(nextULong, "$this$nextULong");
        m908checkULongRangeBoundseb3DHEI(from, until);
        ...
        return ULong.m162constructorimpl(signedResult);
    }
    ...
    public static final long nextULong(Random nextULong, ULongRange range) {
        ...
        if (UnsignedKt.ulongCompare(range.getLast(), -1L) < 0) {
            return m915nextULongjmpaWc(nextULong, range.getFirst(), ULong.m162constructorimpl(range.getLast() + ULong.m162constructorimpl(4294967295L & 1)));
        }
    ...
    public static final byte[] nextUBytes(Random nextUBytes, int size) {
        Intrinsics.checkParameterIsNotNull(nextUBytes, "$this$nextUBytes");
        return UByteArray.m70constructorimpl(nextUBytes.nextBytes(size));
    }
    ...
    public static final byte[] m910nextUBytesWvrt4B4(Random nextUBytes, byte[] array, int fromIndex, int toIndex) {
        Intrinsics.checkParameterIsNotNull(nextUBytes, "$this$nextUBytes");
        Intrinsics.checkParameterIsNotNull(array, "array");
    ...
    public static final void m907checkUIntRangeBoundsJ1ME1BU(int from, int until) {
        if (!(UnsignedKt.uintCompare(until, from) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(UInt.m87boximpl(from), UInt.m87boximpl(until)).toString());
        }
    }

    /* renamed from: checkULongRangeBounds-eb3DHEI, reason: not valid java name */
    public static final void m908checkULongRangeBoundseb3DHEI(long from, long until) {
        if (!(UnsignedKt.ulongCompare(until, from) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(ULong.m156boximpl(from), ULong.m156boximpl(until)).toString());
        }
    }
}
