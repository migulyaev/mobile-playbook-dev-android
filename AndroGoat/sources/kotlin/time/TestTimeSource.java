...
public final class TestTimeSource extends AbstractLongTimeSource {
    ...
    public final void m1008plusAssignLRDsOJo(double duration) {
        long newReading;
        double delta = Duration.m993toDoubleimpl(duration, getUnit());
    ...
    private final void m1007overflowLRDsOJo(double duration) {
        throw new IllegalStateException("TestTimeSource will overflow if its reading " + this.reading + "ns is advanced by " + Duration.m999toStringimpl(duration) + '.');
    }
}
