...
final class AdjustedTimeMark extends TimeMark {
    ...
    public double elapsedNow() {
        return Duration.m984minusLRDsOJo(this.mark.elapsedNow(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo958plusLRDsOJo(double duration) {
        return new AdjustedTimeMark(this.mark, Duration.m985plusLRDsOJo(this.adjustment, duration), null);
    }
}
