...
public final class DurationKt {
    ...
    public static final double toDuration(double $this$toDuration, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m961constructorimpl(DurationUnitKt.convertDurationUnit($this$toDuration, unit, TimeUnit.NANOSECONDS));
    }
    ...
    private static final double m1006timesmvk6XK0(int $this$times, double duration) {
        return Duration.m988timesimpl(duration, $this$times);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final double m1005timeskIfJnKk(double $this$times, double duration) {
        return Duration.m987timesimpl(duration, $this$times);
    }
}
