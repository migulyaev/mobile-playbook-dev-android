...
class NotificationCompatJellybean {
    ...
    public static NotificationCompatBase.Action readAction(NotificationCompatBase.Action.Factory factory, RemoteInputCompatBase.RemoteInput.Factory remoteInputFactory, int icon, CharSequence title, PendingIntent actionIntent, Bundle extras) {
        ...
        if (extras == null) {
            ...
            RemoteInputCompatBase.RemoteInput[] remoteInputs2 = RemoteInputCompatJellybean.fromBundleArray(BundleUtil.getBundleArrayFromBundle(extras, NotificationCompatExtras.EXTRA_REMOTE_INPUTS), remoteInputFactory);
            RemoteInputCompatBase.RemoteInput[] dataOnlyRemoteInputs2 = RemoteInputCompatJellybean.fromBundleArray(BundleUtil.getBundleArrayFromBundle(extras, EXTRA_DATA_ONLY_REMOTE_INPUTS), remoteInputFactory);
