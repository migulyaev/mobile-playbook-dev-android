                    ...
                    if (str != null) {
                        if ("X-B3-TraceId".equalsIgnoreCase(lowerCase)) {
                            ...
                            if (length > 32) {
                                ...
                                bigInteger = qa3.e(length > 16 ? str.substring(length - 16) : str, 16);
                            }
                        } else if ("X-B3-SpanId".equalsIgnoreCase(lowerCase)) {
                            bigInteger2 = qa3.f(str, 16);
    ...
    public static class b implements qa3.d {
        ...
        public void a(z51 z51Var, fj8 fj8Var) {
            try {
                ...
                fj8Var.put("X-B3-TraceId", bigInteger.toLowerCase(locale));
                fj8Var.put("X-B3-SpanId", z51Var.l().toString(16).toLowerCase(locale));
                if (z51Var.q()) {
                    fj8Var.put("X-B3-Sampled", b(z51Var.j()));
                }
