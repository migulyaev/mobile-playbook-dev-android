...
public abstract class sm3 {
    ...
    static final int[] b = {1, 10, 100, NetworkBehavior.DEFAULT_NETWORK_CALL_LIMIT, Constants.MAXIMUM_UPLOAD_PARTS, 100000, 1000000, 10000000, 100000000, Http2Connection.DEGRADED_PONG_TIMEOUT_NS};
