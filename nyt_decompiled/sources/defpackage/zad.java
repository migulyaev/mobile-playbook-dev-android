...
public final class zad extends ContentProvider {
    ...
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        try {
            ...
            fgb.e("Failed to load metadata: Package name not found.", e);
        } catch (NullPointerException e2) {
            fgb.e("Failed to load metadata: Null pointer exception.", e2);
        }
        z2b a = z2b.a();
        if (bundle == null) {
            fgb.d("Metadata was null.");
        } else {
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        if (str != null) {
                            ...
                            fgb.b("Publisher provided Google AdMob App ID in manifest: ".concat(str));
                            ...
                            fgb.b("The Google Mobile Ads SDK is integrated by ".concat(String.valueOf(str2)));
                        }
        ...
        if (bundle != null) {
            ...
            if (z) {
                fgb.b("com.google.android.gms.ads.flag.OPTIMIZE_INITIALIZATION is enabled");
            }
            if (z2) {
                fgb.b("com.google.android.gms.ads.flag.OPTIMIZE_AD_LOADING is enabled");
            }
        }
