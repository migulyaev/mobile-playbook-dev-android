...
public abstract class zo {
    ...
    public static final ch3 a(oe3.a aVar) {
        ...
        ch3.a aVar2 = new ch3.a("Filled.ArrowBackIos", bu1.g(24.0f), bu1.g(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int b = c49.b();
        ox7 ox7Var = new ox7(nn0.b.a(), null);
        int a2 = v48.a.a();
        int a3 = x48.a.a();
        kp5 kp5Var = new kp5();
        kp5Var.i(11.67f, 3.87f);
        kp5Var.g(9.9f, 2.1f);
        kp5Var.g(0.0f, 12.0f);
        kp5Var.h(9.9f, 9.9f);
        kp5Var.h(1.77f, -1.77f);
        kp5Var.g(3.54f, 12.0f);
        kp5Var.a();
