...
public final class mo3 implements h8 {
    ...
    public ho3.e fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (commentStatus != null) {
            return new ho3.e(commentStatus);
        }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, ho3.e eVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(eVar, "value");
        lu3Var.name("status");
