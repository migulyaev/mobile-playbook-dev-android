...
public final class nj5 implements h8 {
    ...
    public hj5.g fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (str3 != null) {
            return new hj5.g(str, str2, str3);
        }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, hj5.g gVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(gVar, "value");
