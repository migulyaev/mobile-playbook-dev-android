...
public final class pf3 implements h8 {
    ...
    public kf3.c fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (num2 != null) {
            return new kf3.c(str, intValue, str2, str3, num2.intValue());
        }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, kf3.c cVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(cVar, "value");
