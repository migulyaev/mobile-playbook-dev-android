...
public final class ux2 implements h8 {
    ...
    public nx2.h fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (str3 != null) {
            return new nx2.h(str, str2, str3);
        }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, nx2.h hVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(hVar, "value");
        ...
        h8Var.toJson(lu3Var, w41Var, hVar.a());
        lu3Var.name("value");
