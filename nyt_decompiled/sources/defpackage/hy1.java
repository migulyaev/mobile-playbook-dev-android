...
public abstract class hy1 {
    ...
    public static final ch3 a(oe3.a aVar) {
        ...
        ch3.a aVar2 = new ch3.a("Filled.Edit", bu1.g(24.0f), bu1.g(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int b = c49.b();
        ox7 ox7Var = new ox7(nn0.b.a(), null);
        int a2 = v48.a.a();
        int a3 = x48.a.a();
        kp5 kp5Var = new kp5();
        kp5Var.i(3.0f, 17.25f);
        kp5Var.l(21.0f);
        kp5Var.f(3.75f);
        kp5Var.g(17.81f, 9.94f);
        kp5Var.h(-3.75f, -3.75f);
        kp5Var.g(3.0f, 17.25f);
        kp5Var.a();
        kp5Var.i(20.71f, 7.04f);
        kp5Var.c(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        kp5Var.h(-2.34f, -2.34f);
        kp5Var.c(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        kp5Var.h(-1.83f, 1.83f);
        kp5Var.h(3.75f, 3.75f);
        kp5Var.h(1.83f, -1.83f);
        kp5Var.a();
