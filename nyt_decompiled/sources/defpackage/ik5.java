...
public final class ik5 implements h8 {
    ...
    public xj5.l fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (str3 != null) {
            return new xj5.l(str, str2, str3);
        }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, xj5.l lVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(lVar, "value");
