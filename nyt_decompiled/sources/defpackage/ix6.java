...
public final class ix6 implements h8 {
    ...
    public gx6.c fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (bool != null) {
            return new gx6.c(bool.booleanValue(), str);
        }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, gx6.c cVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(cVar, "value");
        lu3Var.name("success");
