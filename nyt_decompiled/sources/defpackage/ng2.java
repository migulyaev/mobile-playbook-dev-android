...
public final class ng2 implements h8 {
    ...
    public yf2.n fromJson(JsonReader jsonReader, w41 w41Var) {
        tf2 tf2Var;
        ...
        if (str2 != null) {
            return new yf2.n(str, str2, tf2Var, og2Var);
        }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, yf2.n nVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(nVar, "value");
        lu3Var.name("__typename");
        h8 h8Var = j8.a;
        h8Var.toJson(lu3Var, w41Var, nVar.d());
        lu3Var.name("promotionalHeadline");
        h8Var.toJson(lu3Var, w41Var, nVar.c());
        if (nVar.a() != null) {
            uf2.a.toJson(lu3Var, w41Var, nVar.a());
        }
        if (nVar.b() != null) {
            pg2.a.toJson(lu3Var, w41Var, nVar.b());
        }
    }
}
