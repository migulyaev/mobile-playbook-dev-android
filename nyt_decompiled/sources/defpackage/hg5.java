...
public final class hg5 implements h8 {
    ...
    public cg5.e fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (toggleableUiDirectiveValue != null) {
            return new cg5.e(toggleableUiDirectiveValue);
        }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, cg5.e eVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(eVar, "value");
        lu3Var.name("value");
        in8.a.toJson(lu3Var, w41Var, eVar.a());
    }
}
