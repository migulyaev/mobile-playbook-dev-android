...
public abstract class cp {
    ...
    public static final ch3 a(ne3 ne3Var) {
        ch3.a c;
        ch3 ch3Var = a;
        if (ch3Var != null) {
            zq3.e(ch3Var);
        ...
        ch3.a aVar = new ch3.a("AutoMirrored.Filled.ArrowBack", bu1.g(24.0f), bu1.g(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
        int b = c49.b();
        ox7 ox7Var = new ox7(nn0.b.a(), null);
        int a2 = v48.a.a();
        int a3 = x48.a.a();
        kp5 kp5Var = new kp5();
        kp5Var.i(20.0f, 11.0f);
        kp5Var.e(7.83f);
        kp5Var.h(5.59f, -5.59f);
        kp5Var.g(12.0f, 4.0f);
        kp5Var.h(-8.0f, 8.0f);
        kp5Var.h(8.0f, 8.0f);
