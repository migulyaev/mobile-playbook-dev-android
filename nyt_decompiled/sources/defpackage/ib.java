...
public final class ib implements cy3 {
    private final k43 a;
    private final String b;

    public ib(DataConfigId dataConfigId, k43 k43Var) {
    ...
    public void a() {
        k43.a.b(this.a, "login", "login on paywall", null, "link", "button", "tap", null, 68, null);
    }
    ...
    public void c(zc5 zc5Var, f46 f46Var) {
        ...
        k43.a.b(this.a, "gateway", h.c1("aa " + F).toString(), null, "button", null, "tap", null, 84, null);
    }
    ...
    public void f(ComponentActivity componentActivity, boolean z) {
        ...
        k43.a.a(this.a, "gateway", "AND_PAYWALL_CORE", "paywall", null, 8, null);
    }
}
