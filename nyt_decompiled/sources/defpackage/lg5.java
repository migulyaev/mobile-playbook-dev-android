...
public final class lg5 implements h8 {
    ...
    public cg5.h fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (toggleableUiDirectiveValue != null) {
            return new cg5.h(toggleableUiDirectiveValue);
        }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, cg5.h hVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(hVar, "value");
        lu3Var.name("value");
        in8.a.toJson(lu3Var, w41Var, hVar.a());
    }
}
