...
public final class u59 implements h8 {
    public static final u59 a = new u59();
    ...
    public n59.g fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (str3 != null) {
            return new n59.g(str, str2, str3);
        }
        vr.a(jsonReader, "seo");
        throw new KotlinNothingValueException();
    }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, n59.g gVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(gVar, "value");
