...
public final class k22 implements h8 {
    ...
    public h22.b fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (str3 != null) {
            return new h22.b(str, str2, intValue, intValue2, str3);
        }
        vr.a(jsonReader, "url");
        throw new KotlinNothingValueException();
    }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, h22.b bVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(bVar, "value");
