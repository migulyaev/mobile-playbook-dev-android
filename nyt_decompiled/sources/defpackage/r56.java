...
public final class r56 implements rp2 {
    ...
    public static final class c {
        ...
        public c(String str, wp3 wp3Var) {
            zq3.h(str, "__typename");
            zq3.h(wp3Var, "interestPromoImageFragment");
            this.a = str;
            this.b = wp3Var;
        }
        ...
        public String toString() {
            return "OnImage(__typename=" + this.a + ", interestPromoImageFragment=" + this.b + ")";
        }
    }
    ...
    public static final class g {
        ...
        public g(String str, wp3 wp3Var) {
            zq3.h(str, "__typename");
            this.a = str;
            this.b = wp3Var;
        }
        ...
        public String toString() {
            return "PromotionalMedia1(__typename=" + this.a + ", interestPromoImageFragment=" + this.b + ")";
        }
    }
    ...
    public static final class h {
        ...
        public h(String str, wp3 wp3Var) {
            zq3.h(str, "__typename");
            this.a = str;
            this.b = wp3Var;
        }
        ...
        public String toString() {
            return "PromotionalMedia2(__typename=" + this.a + ", interestPromoImageFragment=" + this.b + ")";
        }
    }
    ...
    public static final class i {
        ...
        public i(String str, wp3 wp3Var) {
            zq3.h(str, "__typename");
            this.a = str;
            this.b = wp3Var;
        }
        ...
        public String toString() {
            return "PromotionalMedia3(__typename=" + this.a + ", interestPromoImageFragment=" + this.b + ")";
        }
    }
    ...
    public static final class j {
        ...
        public j(String str, wp3 wp3Var) {
            zq3.h(str, "__typename");
            this.a = str;
            this.b = wp3Var;
        }
    ...
    public r56(String str, c cVar, e eVar, d dVar, a aVar, b bVar) {
        zq3.h(str, "__typename");
        this.a = str;
        this.b = cVar;
        this.c = eVar;
    ...
    public boolean equals(Object obj) {
        ...
        r56 r56Var = (r56) obj;
        return zq3.c(this.a, r56Var.a) && zq3.c(this.b, r56Var.b) && zq3.c(this.c, r56Var.c) && zq3.c(this.d, r56Var.d) && zq3.c(this.e, r56Var.e) && zq3.c(this.f, r56Var.f);
    }
    ...
    public String toString() {
        return "PromotionalMedia(__typename=" + this.a + ", onImage=" + this.b + ", onVideo=" + this.c + ", onSlideshow=" + this.d + ", onAudio=" + this.e + ", onEmbeddedInteractive=" + this.f + ")";
    }
}
