...
public final class bc2 implements h8 {
    ...
    public wb2.e fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (commentStatus != null) {
            return new wb2.e(commentStatus);
        }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, wb2.e eVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(eVar, "value");
        lu3Var.name("status");
