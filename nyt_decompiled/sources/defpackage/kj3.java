...
public final class kj3 implements h8 {
    ...
    public hj3.b fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (str3 != null) {
            return new hj3.b(str, str2, str3);
        }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, hj3.b bVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(bVar, "value");
