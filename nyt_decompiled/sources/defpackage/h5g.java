...
public abstract class h5g {
    ...
    public static KeyPair c(ECParameterSpec eCParameterSpec) {
        KeyPairGenerator keyPairGenerator = (KeyPairGenerator) l5g.j.a("EC");
    ...
    static void f(ECPublicKey eCPublicKey, ECPrivateKey eCPrivateKey) {
        try {
    ...
    public static byte[] g(ECPrivateKey eCPrivateKey, ECPublicKey eCPublicKey) {
        ...
        PublicKey generatePublic = ((KeyFactory) l5g.k.a("EC")).generatePublic(new ECPublicKeySpec(w, eCPrivateKey.getParams()));
        KeyAgreement keyAgreement = (KeyAgreement) l5g.i.a("ECDH");
    ...
    public static ECPrivateKey h(int i, byte[] bArr) {
        return (ECPrivateKey) ((KeyFactory) l5g.k.a("EC")).generatePrivate(new ECPrivateKeySpec(new BigInteger(1, bArr), k(i)));
    }
    ...
    public static ECPublicKey i(int i, byte[] bArr, byte[] bArr2) {
        ...
        return (ECPublicKey) ((KeyFactory) l5g.k.a("EC")).generatePublic(new ECPublicKeySpec(eCPoint, k));
    }
