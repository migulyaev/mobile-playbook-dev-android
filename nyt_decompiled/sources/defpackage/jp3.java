...
public final class jp3 implements h8 {
    ...
    public ip3.a fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (str3 != null) {
            return new ip3.a(str, str2, str3);
        }
        vr.a(jsonReader, "seo");
        throw new KotlinNothingValueException();
    }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, ip3.a aVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(aVar, "value");
