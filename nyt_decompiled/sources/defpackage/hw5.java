...
public final class hw5 implements h8 {
    ...
    public aw5.h fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (podcastService != null) {
            return new aw5.h(str, str2, podcastService);
        }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, aw5.h hVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(hVar, "value");
