...
public final class gg2 implements h8 {
    ...
    public yf2.h fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (num != null) {
            return new yf2.h(str, str2, num.intValue());
        }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, yf2.h hVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(hVar, "value");
        ...
        j8.b.toJson(lu3Var, w41Var, Integer.valueOf(hVar.a()));
    }
}
