...
public abstract class e7d {
    ...
    public static ArrayList c(SQLiteDatabase sQLiteDatabase) {
        ...
        while (query.moveToNext()) {
            try {
                arrayList.add(c4.V(query.getBlob(query.getColumnIndexOrThrow("serialized_proto_data"))));
            } catch (zzhag e) {
                fgb.d("Unable to deserialize proto from offline signals database:");
                fgb.d(e.getMessage());
            }
        }
        query.close();
    ...
    private static Cursor h(SQLiteDatabase sQLiteDatabase, int i) {
        String[] strArr = {"value"};
    ...
    private static void i(SQLiteDatabase sQLiteDatabase, String str, int i) {
        ContentValues contentValues = new ContentValues();
    ...
    private static void j(SQLiteDatabase sQLiteDatabase, String str, int i) {
        ContentValues contentValues = new ContentValues();
        contentValues.put("value", (Integer) 0);
