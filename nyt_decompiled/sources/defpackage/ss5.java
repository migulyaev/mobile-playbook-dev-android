...
public final class ss5 implements h8 {
    ...
    public ls5.h fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (str3 != null) {
            return new ls5.h(str, str2, str3);
        }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, ls5.h hVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(hVar, "value");
