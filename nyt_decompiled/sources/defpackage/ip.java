...
public final class ip implements h8 {
    ...
    public gp.b fromJson(JsonReader jsonReader, w41 w41Var) {
        ...
        if (sensitivity != null) {
            return new gp.b(str, sensitivity);
        }
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, gp.b bVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(bVar, "value");
