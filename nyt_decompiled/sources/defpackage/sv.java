...
public final class sv implements h8 {
    ...
    public lv.f fromJson(JsonReader jsonReader, w41 w41Var) {
    ...
    public void toJson(lu3 lu3Var, w41 w41Var, lv.f fVar) {
        zq3.h(lu3Var, "writer");
        zq3.h(w41Var, "customScalarAdapters");
        zq3.h(fVar, "value");
        lu3Var.name("default");
