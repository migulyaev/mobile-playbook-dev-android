...
public final class MaybeTakeUntilPublisher<T, U> extends AbstractMaybeWithUpstream<T, T> {
    ...
    static final class TakeUntilMainMaybeObserver<T, U> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable {
        ...
        static final class TakeUntilOtherMaybeObserver<U> extends AtomicReference<hb8> implements FlowableSubscriber<U> {
    ...
    public MaybeTakeUntilPublisher(MaybeSource<T> maybeSource, g86 g86Var) {
        super(maybeSource);
        this.other = g86Var;
    }
