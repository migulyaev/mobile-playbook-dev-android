...
public final class FlowableMap<T, U> extends AbstractFlowableWithUpstream<T, U> {
    ...
    static final class MapSubscriber<T, U> extends BasicFuseableSubscriber<T, U> {
        ...
        MapSubscriber(va8 va8Var, Function<? super T, ? extends U> function) {
            super(va8Var);
            this.mapper = function;
        }
    ...
    protected void subscribeActual(va8 va8Var) {
        if (va8Var instanceof ConditionalSubscriber) {
            this.source.subscribe((FlowableSubscriber) new MapConditionalSubscriber((ConditionalSubscriber) va8Var, this.mapper));
        } else {
            this.source.subscribe((FlowableSubscriber) new MapSubscriber(va8Var, this.mapper));
        }
    }
}
