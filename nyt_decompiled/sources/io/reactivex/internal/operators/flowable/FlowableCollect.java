...
public final class FlowableCollect<T, U> extends AbstractFlowableWithUpstream<T, U> {
    ...
    static final class CollectSubscriber<T, U> extends DeferredScalarSubscription<U> implements FlowableSubscriber<T> {
        ...
        CollectSubscriber(va8 va8Var, U u, BiConsumer<? super U, ? super T> biConsumer) {
            super(va8Var);
    ...
    protected void subscribeActual(va8 va8Var) {
        try {
            this.source.subscribe((FlowableSubscriber) new CollectSubscriber(va8Var, ObjectHelper.requireNonNull(this.initialSupplier.call(), "The initial value supplied is null"), this.collector));
        } catch (Throwable th) {
