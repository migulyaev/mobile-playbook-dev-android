...
public final class ObservableScalarXMap {
    ...
    public static <T, R> boolean tryScalarXMapSubscribe(ObservableSource<T> observableSource, Observer<? super R> observer, Function<? super T, ? extends ObservableSource<? extends R>> function) {
        ...
        try {
            PrivacySettingsScreenKt$PrivacySettingsScreen$1$5 privacySettingsScreenKt$PrivacySettingsScreen$1$5 = (Object) ((Callable) observableSource).call();
            if (privacySettingsScreenKt$PrivacySettingsScreen$1$5 == null) {
                EmptyDisposable.complete(observer);
                return true;
            }
            try {
                ObservableSource observableSource2 = (ObservableSource) ObjectHelper.requireNonNull(function.apply(privacySettingsScreenKt$PrivacySettingsScreen$1$5), "The mapper returned a null ObservableSource");
