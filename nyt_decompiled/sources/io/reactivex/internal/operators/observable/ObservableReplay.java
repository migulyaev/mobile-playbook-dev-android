...
public final class ObservableReplay<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T>, ResettableConnectable {
    ...
    static final class ReplayObserver<T> extends AtomicReference<Disposable> implements Observer<T>, Disposable {
        ...
        boolean add(InnerDisposable<T> innerDisposable) {
            ...
            } while (!kz4.a(this.observers, innerDisposableArr, innerDisposableArr2));
            return true;
        }
    ...
    static final class ReplaySource<T> implements ObservableSource<T> {
        ...
        public void subscribe(Observer<? super T> observer) {
            ...
            while (true) {
                ...
                if (kz4.a(this.curr, null, replayObserver2)) {
    ...
    public void connect(Consumer<? super Disposable> consumer) {
        ...
        while (true) {
            ...
            ReplayObserver<T> replayObserver2 = new ReplayObserver<>(this.bufferFactory.call());
            if (kz4.a(this.current, replayObserver, replayObserver2)) {
                replayObserver = replayObserver2;
                break;
            }
        }
    ...
    public void resetIf(Disposable disposable) {
        kz4.a(this.current, (ReplayObserver) disposable, null);
    }
