...
public final class Functions {
    ...
    public static final Consumer<hb8> REQUEST_MAX = new MaxRequestSubscription();
    ...
    public static class BoundedConsumer implements Consumer<hb8> {
    ...
    static final class MaxRequestSubscription implements Consumer<hb8> {
