...
public final class AndroidLog {
    ...
    static {
        ...
        zq3.g(name2, "OkHttpClient::class.java.name");
        linkedHashMap.put(name2, "okhttp.OkHttpClient");
        String name3 = Http2.class.getName();
        zq3.g(name3, "Http2::class.java.name");
        linkedHashMap.put(name3, "okhttp.Http2");
        String name4 = TaskRunner.class.getName();
        zq3.g(name4, "TaskRunner::class.java.name");
        linkedHashMap.put(name4, "okhttp.TaskRunner");
        linkedHashMap.put("okhttp3.mockwebserver.MockWebServer", "okhttp.MockWebServer");
        knownLoggers = t.v(linkedHashMap);
    }
    ...
    private final String loggerTag(String str) {
        ...
        return str2 == null ? h.l1(str, 23) : str2;
    }
    ...
    public final void androidLog$okhttp(String str, int i, String str2, Throwable th) {
        ...
        if (Log.isLoggable(loggerTag, i)) {
            ...
            while (i2 < length) {
                ...
                while (true) {
                    min = Math.min(a0, i2 + MAX_LOG_LENGTH);
