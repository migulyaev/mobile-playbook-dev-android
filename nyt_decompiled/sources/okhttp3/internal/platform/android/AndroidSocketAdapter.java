...
public class AndroidSocketAdapter implements SocketAdapter {
    ...
    public static final class Companion {
        ...
        public final AndroidSocketAdapter build(Class<? super SSLSocket> cls) {
            ...
            while (cls2 != null && !zq3.c(cls2.getSimpleName(), "OpenSSLSocketImpl")) {
        ...
        public final DeferredSocketAdapter.Factory factory(final String str) {
            ...
            return new DeferredSocketAdapter.Factory() { // from class: okhttp3.internal.platform.android.AndroidSocketAdapter$Companion$factory$1
                ...
                public boolean matchesSocket(SSLSocket sSLSocket) {
                    ...
                    zq3.g(name, "sslSocket.javaClass.name");
                    return h.K(name, str + '.', false, 2, null);
                }
            };
        }
    ...
    public AndroidSocketAdapter(Class<? super SSLSocket> cls) {
        zq3.h(cls, "sslSocketClass");
        this.sslSocketClass = cls;
        Method declaredMethod = cls.getDeclaredMethod("setUseSessionTickets", Boolean.TYPE);
        zq3.g(declaredMethod, "sslSocketClass.getDeclar…:class.javaPrimitiveType)");
    ...
    public String getSelectedProtocol(SSLSocket sSLSocket) {
        ...
        try {
            ...
            if ((cause instanceof NullPointerException) && zq3.c(((NullPointerException) cause).getMessage(), "ssl == null")) {
                return null;
            }
            throw new AssertionError(e2);
        }
