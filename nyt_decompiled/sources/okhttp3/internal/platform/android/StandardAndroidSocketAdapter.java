...
public final class StandardAndroidSocketAdapter extends AndroidSocketAdapter {
    ...
    public static final class Companion {
        ...
        public final SocketAdapter buildIfSupported(String str) {
            ...
            try {
                ...
                zq3.f(cls, "null cannot be cast to non-null type java.lang.Class<in javax.net.ssl.SSLSocket>");
                Class<?> cls2 = Class.forName(str + ".OpenSSLSocketFactoryImpl");
                zq3.f(cls2, "null cannot be cast to non-null type java.lang.Class<in javax.net.ssl.SSLSocketFactory>");
                Class<?> cls3 = Class.forName(str + ".SSLParametersImpl");
                zq3.g(cls3, "paramsClass");
    ...
    public StandardAndroidSocketAdapter(Class<? super SSLSocket> cls, Class<? super SSLSocketFactory> cls2, Class<?> cls3) {
        ...
        zq3.h(cls2, "sslSocketFactoryClass");
        zq3.h(cls3, "paramClass");
