...
public final class Exchange {
    ...
    private final class RequestBodySink extends np2 {
        ...
        public RequestBodySink(Exchange exchange, yt7 yt7Var, long j) {
            super(yt7Var);
    ...
    public final class ResponseBodySource extends op2 {
        private long bytesReceived;
        private boolean closed;
        private boolean completed;
        private final long contentLength;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public ResponseBodySource(Exchange exchange, px7 px7Var, long j) {
            super(px7Var);
    ...
    public Exchange(RealCall realCall, EventListener eventListener, ExchangeFinder exchangeFinder, ExchangeCodec exchangeCodec) {
        ...
        zq3.h(exchangeFinder, "finder");
        zq3.h(exchangeCodec, "codec");
        this.call = realCall;
    ...
    public final yt7 createRequestBody(Request request, boolean z) throws IOException {
    ...
    public final boolean isCoalescedConnection$okhttp() {
        return !zq3.c(this.finder.getAddress$okhttp().url().host(), this.connection.route().address().url().host());
    }
    ...
    public final ResponseBody openResponseBody(Response response) throws IOException {
        ...
        try {
            ...
            return new RealResponseBody(header$default, reportedContentLength, wd5.d(new ResponseBodySource(this, this.codec.openResponseBodySource(response), reportedContentLength)));
        } catch (IOException e) {
            this.eventListener.responseFailed(this.call, e);
            trackFailure(e);
            throw e;
