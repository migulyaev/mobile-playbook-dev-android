...
public final class Hpack {
    ...
    public static final class Reader {
        ...
        public Reader(px7 px7Var, int i) {
            this(px7Var, i, 0, 4, null);
            zq3.h(px7Var, "source");
        }
        ...
        private final void clearDynamicTable() {
            d.w(this.dynamicTable, null, 0, 0, 6, null);
        ...
        public final List<Header> getAndResetHeaderList() {
            List<Header> X0 = i.X0(this.headerList);
        ...
        public final ByteString readByteString() throws IOException {
            ...
            if (!z) {
                return this.source.u0(readInt);
            }
            ad0 ad0Var = new ad0();
            Huffman.INSTANCE.decode(this.source, readInt, ad0Var);
            return ad0Var.a1();
        }
        ...
        public Reader(px7 px7Var, int i, int i2) {
            zq3.h(px7Var, "source");
            this.headerTableSizeSetting = i;
            this.maxDynamicTableByteCount = i2;
            this.headerList = new ArrayList();
            this.source = wd5.d(px7Var);
            this.dynamicTable = new Header[8];
            this.nextHeaderIndex = r2.length - 1;
        }

        public /* synthetic */ Reader(px7 px7Var, int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
            this(px7Var, i, (i3 & 4) != 0 ? i : i2);
        }
    }
    ...
    public static final class Writer {
        ...
        private int nextHeaderIndex;
        private final ad0 out;
        private int smallestHeaderTableSizeSetting;
        private final boolean useCompression;

        /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
        public Writer(int i, ad0 ad0Var) {
            this(i, false, ad0Var, 2, null);
            zq3.h(ad0Var, "out");
        }
        ...
        public final void writeByteString(ByteString byteString) throws IOException {
            ...
            if (this.useCompression) {
                ...
                if (huffman.encodedLength(byteString) < byteString.E()) {
                    ad0 ad0Var = new ad0();
                    huffman.encode(byteString, ad0Var);
                    ByteString a1 = ad0Var.a1();
                    writeInt(a1.E(), 127, 128);
                    this.out.m1(a1);
                    return;
                }
            }
            writeInt(byteString.E(), 127, 0);
            this.out.m1(byteString);
        }
        ...
        public final void writeHeaders(List<Header> list) throws IOException {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                ByteString I = header.name.I();
                ByteString byteString = header.value;
                Hpack hpack = Hpack.INSTANCE;
                Integer num = hpack.getNAME_TO_FIRST_INDEX().get(I);
                if (num != null) {
                    int intValue = num.intValue();
                    i2 = intValue + 1;
                    if (2 <= i2 && i2 < 8) {
                        if (zq3.c(hpack.getSTATIC_HEADER_TABLE()[intValue].value, byteString)) {
                            i = i2;
                        } else if (zq3.c(hpack.getSTATIC_HEADER_TABLE()[i2].value, byteString)) {
                            i = i2;
                            i2 = intValue + 2;
                        }
                    }
                ...
                if (i2 == -1) {
                    ...
                    while (true) {
                        ...
                        zq3.e(header2);
                        if (zq3.c(header2.name, I)) {
                            Header header3 = this.dynamicTable[i5];
                            zq3.e(header3);
                            if (zq3.c(header3.value, byteString)) {
                ...
                } else if (!I.F(Header.PSEUDO_PREFIX) || zq3.c(Header.TARGET_AUTHORITY, I)) {
        ...
        /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
        public Writer(ad0 ad0Var) {
            this(0, false, ad0Var, 3, null);
            zq3.h(ad0Var, "out");
        }

        public Writer(int i, boolean z, ad0 ad0Var) {
            zq3.h(ad0Var, "out");
            this.headerTableSizeSetting = i;
        ...
        public /* synthetic */ Writer(int i, boolean z, ad0 ad0Var, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? 4096 : i, (i2 & 2) != 0 ? true : z, ad0Var);
        }
    }
    ...
    static {
        ...
        STATIC_HEADER_TABLE = new Header[]{header, header2, header3, header4, header5, header6, header7, new Header(byteString4, "200"), new Header(byteString4, "204"), new Header(byteString4, "206"), new Header(byteString4, "304"), new Header(byteString4, "400"), new Header(byteString4, "404"), new Header(byteString4, "500"), new Header("accept-charset", ""), new Header("accept-encoding", "gzip, deflate"), new Header("accept-language", ""), new Header("accept-ranges", ""), new Header("accept", ""), new Header("access-control-allow-origin", ""), new Header("age", ""), new Header("allow", ""), new Header("authorization", ""), new Header("cache-control", ""), new Header("content-disposition", ""), new Header("content-encoding", ""), new Header("content-language", ""), new Header("content-length", ""), new Header("content-location", ""), new Header("content-range", ""), new Header("content-type", ""), new Header(ChallengeActivity.ARG_COOKIE, ""), new Header("date", ""), new Header(TransferTable.COLUMN_ETAG, ""), new Header("expect", ""), new Header("expires", ""), new Header("from", ""), new Header("host", ""), new Header("if-match", ""), new Header("if-modified-since", ""), new Header("if-none-match", ""), new Header("if-range", ""), new Header("if-unmodified-since", ""), new Header("last-modified", ""), new Header("link", ""), new Header("location", ""), new Header("max-forwards", ""), new Header("proxy-authenticate", ""), new Header("proxy-authorization", ""), new Header("range", ""), new Header("referer", ""), new Header("refresh", ""), new Header("retry-after", ""), new Header("server", ""), new Header("set-cookie", ""), new Header("strict-transport-security", ""), new Header("transfer-encoding", ""), new Header("user-agent", ""), new Header("vary", ""), new Header("via", ""), new Header("www-authenticate", "")};
    ...
    private final Map<ByteString, Integer> nameToFirstIndex() {
        ...
        zq3.g(unmodifiableMap, "unmodifiableMap(result)");
