...
@fc1(c = "com.iteratehq.iterate.data.remote.DefaultIterateApi$displayed$1", f = "IterateApi.kt", l = {173}, m = "invokeSuspend")
/* loaded from: classes3.dex */
final class DefaultIterateApi$displayed$1 extends SuspendLambda implements ss2 {
    final /* synthetic */ Survey $survey;
    int label;
    final /* synthetic */ DefaultIterateApi this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    DefaultIterateApi$displayed$1(Survey survey, DefaultIterateApi defaultIterateApi, by0 by0Var) {
        super(1, by0Var);
        this.$survey = survey;
    ...
    public final by0 create(by0 by0Var) {
        return new DefaultIterateApi$displayed$1(this.$survey, this.this$0, by0Var);
    }

    @Override // defpackage.ss2
    public final Object invoke(by0 by0Var) {
        return ((DefaultIterateApi$displayed$1) create(by0Var)).invokeSuspend(ww8.a);
    }
