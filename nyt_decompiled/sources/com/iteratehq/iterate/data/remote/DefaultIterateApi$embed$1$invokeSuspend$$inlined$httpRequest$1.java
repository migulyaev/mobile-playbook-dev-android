...
public final class DefaultIterateApi$embed$1$invokeSuspend$$inlined$httpRequest$1 extends SuspendLambda implements gt2 {
    ...
    public DefaultIterateApi$embed$1$invokeSuspend$$inlined$httpRequest$1(DefaultIterateApi defaultIterateApi, String str, Object obj, Method method, by0 by0Var) {
        super(2, by0Var);
    ...
    public final by0 create(Object obj, by0 by0Var) {
        return new DefaultIterateApi$embed$1$invokeSuspend$$inlined$httpRequest$1(this.this$0, this.$path, this.$body, this.$method, by0Var);
    }
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        ApiResponse apiResponse = (ApiResponse) gson.fromJson(sb3.toString(), TypeToken.getParameterized(ApiResponse.class, EmbedResults.class).getType());
    ...
    public final Object invoke(CoroutineScope coroutineScope, by0 by0Var) {
        return ((DefaultIterateApi$embed$1$invokeSuspend$$inlined$httpRequest$1) create(coroutineScope, by0Var)).invokeSuspend(ww8.a);
    }
}
