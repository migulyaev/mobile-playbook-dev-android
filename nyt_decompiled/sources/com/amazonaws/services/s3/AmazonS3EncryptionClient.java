...
public class AmazonS3EncryptionClient extends AmazonS3Client implements AmazonS3Encryption {
    ...
    public void deleteObject(DeleteObjectRequest deleteObjectRequest) {
        ...
        DeleteObjectRequest deleteObjectRequest2 = (DeleteObjectRequest) deleteObjectRequest.mo156clone();
    ...
    @Override // com.amazonaws.services.s3.AmazonS3Client, com.amazonaws.services.s3.AmazonS3, com.amazonaws.services.s3.internal.S3DirectSpi
    public PutObjectResult putObject(PutObjectRequest putObjectRequest) {
        return this.crypto.putObjectSecurely(putObjectRequest.mo156clone());
    }
            ...
            try {
                try {
                    try {
                        ...
                        Iterator<Future<UploadPartResult>> it2 = uploadObjectObserver.getFutures().iterator();
                        while (it2.hasNext()) {
                            UploadPartResult uploadPartResult = it2.next().get();
                        ...
                        throw ((ExecutionException) onAbort(uploadObjectObserver, e));
                    }
                } catch (IOException e2) {
                    throw ((IOException) onAbort(uploadObjectObserver, e2));
