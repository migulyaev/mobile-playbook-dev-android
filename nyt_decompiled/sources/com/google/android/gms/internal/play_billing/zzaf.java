...
final class zzaf extends zzx {
    static final zzx g = new zzaf(null, new Object[0], 0);
    ...
    static zzaf i(int i, Object[] objArr, v2 v2Var) {
        int i2;
        short[] sArr;
        Object[] objArr2;
        int i3 = i;
        ...
        aff.b(i3, objArr3.length >> 1, "index");
        char c = 2;
                    ...
                    while (true) {
                        ...
                        if (i10 == 255) {
                            ...
                            if (obj6.equals(objArr3[i10])) {
                                ...
                                obj8.getClass();
                                u2 u2Var = new u2(obj6, obj7, obj8);
                                objArr3[i11] = obj7;
                                obj = u2Var;
                                break;
                            }
                    ...
                    while (true) {
                        ...
                        if (c3 == 65535) {
                            ...
                            if (obj9.equals(objArr3[c3])) {
                                ...
                                obj11.getClass();
                                u2 u2Var2 = new u2(obj9, obj10, obj11);
                                objArr3[i17] = obj10;
                                obj = u2Var2;
                                break;
                            }
                    ...
                    while (true) {
                        ...
                        if (r15 == c2) {
                            ...
                            if (obj12.equals(objArr3[r15])) {
                                ...
                                obj14.getClass();
                                u2 u2Var3 = new u2(obj12, obj13, obj14);
                                objArr3[i23] = obj13;
                                obj = u2Var3;
                                break;
                            }
    ...
    final zzr a() {
        return new zzae(this.e, 1, this.f);
    }

    @Override // com.google.android.gms.internal.play_billing.zzx
    final zzy d() {
        return new zzac(this, this.e, 0, this.f);
    }

    @Override // com.google.android.gms.internal.play_billing.zzx
    final zzy f() {
        return new zzad(this, new zzae(this.e, 0, this.f));
    }
    ...
    */
    public final java.lang.Object get(java.lang.Object r9) {
        ...
        L25:
            ...
            int r5 = r0 + (-1)
            int r0 = r9.hashCode()
            int r0 = com.google.android.gms.internal.play_billing.s2.a(r0)
        L38:
            r0 = r0 & r5
            r4 = r8[r0]
        ...
        L7d:
            ...
            int r8 = r8 + r4
            int r5 = r9.hashCode()
            int r5 = com.google.android.gms.internal.play_billing.s2.a(r5)
        L89:
            r5 = r5 & r8
            r6 = r0[r5]
            if (r6 != r4) goto L90
