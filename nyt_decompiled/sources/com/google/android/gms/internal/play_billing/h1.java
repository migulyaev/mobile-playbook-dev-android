...
abstract class h1 {
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.play_billing.h1.<clinit>():void");
    }
    ...
    public static void d(Object obj, long j, byte b2) {
        g1 g1Var = d;
        long j2 = (-4) & j;
        int i = g1Var.a.getInt(obj, j2);
        int i2 = ((~((int) j)) & 3) << 3;
        g1Var.a.putInt(obj, j2, ((255 & b2) << i2) | (i & (~(255 << i2))));
    }
    ...
    public static void e(Object obj, long j, byte b2) {
        ...
        long j2 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        g1Var.a.putInt(obj, j2, ((255 & b2) << i) | (g1Var.a.getInt(obj, j2) & (~(255 << i))));
    }
    ...
    static /* bridge */ /* synthetic */ void m(Throwable th) {
        Logger.getLogger(h1.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
