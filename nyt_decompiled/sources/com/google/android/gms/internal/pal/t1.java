...
abstract class t1 {
    ...
    */
    static int b(java.lang.CharSequence r7, byte[] r8, int r9, int r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.pal.t1.b(java.lang.CharSequence, byte[], int, int):int");
    }
    ...
    static String d(byte[] bArr, int i, int i2) {
        ...
        while (i < i3) {
            ...
            if (q1.d(b2)) {
                ...
                int i7 = i + 2;
                i += 3;
                q1.b(b2, bArr[i6], bArr[i7], cArr, i5);
                i5++;
            } else {
                if (i6 >= i3 - 2) {
                    throw zzadi.d();
                ...
                int i9 = i + 3;
                i += 4;
                q1.a(b2, bArr[i6], bArr[i8], bArr[i9], cArr, i5);
                i5 += 2;
            }
        }
