...
abstract class p1 {
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.pal.p1.<clinit>():void");
    }
    ...
    public static void d(Object obj, long j, byte b2) {
        long j2 = (-4) & j;
        o1 o1Var = d;
        int j3 = o1Var.j(obj, j2);
        int i = ((~((int) j)) & 3) << 3;
        o1Var.n(obj, j2, ((255 & b2) << i) | (j3 & (~(255 << i))));
    }
    ...
    public static void e(Object obj, long j, byte b2) {
        ...
        o1 o1Var = d;
        int i = (((int) j) & 3) << 3;
        o1Var.n(obj, j2, ((255 & b2) << i) | (o1Var.j(obj, j2) & (~(255 << i))));
    }
    ...
    static /* bridge */ /* synthetic */ void m(Throwable th) {
        Logger.getLogger(p1.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
