...
final class r extends s {
    ...
    public final void D(byte[] bArr, int i, int i2) {
        try {
            ...
            throw new zzacf(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f), Integer.valueOf(this.e), Integer.valueOf(i2)), e);
        }
    }
    ...
    public final void E(String str) {
        int i = this.f;
        try {
            int a = s.a(str.length() * 3);
            int a2 = s.a(str.length());
            if (a2 != a) {
                u(t1.c(str));
                byte[] bArr = this.d;
                int i2 = this.f;
                this.f = t1.b(str, bArr, i2, this.e - i2);
                return;
            }
            int i3 = i + a2;
            this.f = i3;
            int b = t1.b(str, this.d, i3, this.e - i3);
            this.f = i;
            u((b - i) - a2);
            this.f = b;
        } catch (zzafw e) {
    ...
    public final void w(long j) {
        ...
        if (z && this.e - this.f >= 10) {
            while ((j & (-128)) != 0) {
                ...
                int i = this.f;
                this.f = i + 1;
                p1.s(bArr, i, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr2 = this.d;
            int i2 = this.f;
            this.f = i2 + 1;
            p1.s(bArr2, i2, (byte) j);
            return;
        }
        while ((j & (-128)) != 0) {
            try {
