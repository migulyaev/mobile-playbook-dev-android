...
class zzcs<T extends zzcq> extends zzbr {
            ...
            while (eventType != 1) {
                if (xmlResourceParser.getEventType() == 2) {
                    ...
                    if (lowerCase.equals("screenname")) {
                        String attributeValue = xmlResourceParser.getAttributeValue(null, AuthenticationTokenClaims.JSON_KEY_NAME);
                        String trim = xmlResourceParser.nextText().trim();
                        if (!TextUtils.isEmpty(attributeValue) && !TextUtils.isEmpty(trim)) {
                            this.zza.zzb(attributeValue, trim);
                        }
                    } else if (lowerCase.equals("string")) {
                        String attributeValue2 = xmlResourceParser.getAttributeValue(null, AuthenticationTokenClaims.JSON_KEY_NAME);
                        String trim2 = xmlResourceParser.nextText().trim();
                        if (!TextUtils.isEmpty(attributeValue2) && trim2 != null) {
                            this.zza.zze(attributeValue2, trim2);
                        }
                    } else if (lowerCase.equals("bool")) {
                        String attributeValue3 = xmlResourceParser.getAttributeValue(null, AuthenticationTokenClaims.JSON_KEY_NAME);
                        ...
                        String attributeValue4 = xmlResourceParser.getAttributeValue(null, AuthenticationTokenClaims.JSON_KEY_NAME);
    ...
    public final T zza(int i) {
        try {
            ...
            this.zzS("inflate() called with unknown resourceId", e);
            return null;
        }
    }
}
