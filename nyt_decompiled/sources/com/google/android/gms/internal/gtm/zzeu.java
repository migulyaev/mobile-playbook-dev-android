...
public abstract class zzeu {
    ...
    static {
        ...
        Long valueOf2 = Long.valueOf(BackgroundActivityBehavior.MIN_BACKGROUND_ACTIVITY_DURATION_DEFAULT);
        zzj = zzet.zza(valueOf2, valueOf2, new zzes() { // from class: com.google.android.gms.internal.gtm.zzel
        });
        ...
        zzL = zzet.zza(valueOf2, valueOf2, new zzes() { // from class: com.google.android.gms.internal.gtm.zzdy
        });
        zzM = zzet.zza(valueOf2, valueOf2, new zzes() { // from class: com.google.android.gms.internal.gtm.zzdz
        });
        ...
        zzQ = zzet.zza(valueOf2, valueOf2, new zzes() { // from class: com.google.android.gms.internal.gtm.zzee
        });
