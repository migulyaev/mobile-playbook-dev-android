...
final class zzcd extends SQLiteOpenHelper {
    ...
    private final boolean zza(SQLiteDatabase sQLiteDatabase, String str) {
        ...
        try {
            try {
                cursor = sQLiteDatabase.query("SQLITE_MASTER", new String[]{AuthenticationTokenClaims.JSON_KEY_NAME}, "name=?", new String[]{str}, null, null, null);
    ...
    public final SQLiteDatabase getWritableDatabase() {
        ...
        if (!zzfoVar.zzc(AbraPackageKt.MS_IN_HOUR)) {
