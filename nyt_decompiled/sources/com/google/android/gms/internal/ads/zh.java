...
final class zh extends tg implements RandomAccess, p0f, ti {
    private static final zh d = new zh(new int[0], 0, false);
    private int[] b;
    private int c;

    private zh(int[] iArr, int i, boolean z) {
        super(z);
        this.b = iArr;
        this.c = i;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        System.arraycopy(zhVar.b, 0, this.b, this.c, zhVar.c);
        this.c = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final p0f zzd(int i) {
        if (i >= this.c) {
            return new zh(Arrays.copyOf(this.b, i), this.c, true);
        }
