...
final class c2 implements x3 {
    ...
    public static c2 d(b2 b2Var) {
        c2 c2Var = b2Var.a;
        return c2Var != null ? c2Var : new c2(b2Var);
    }

    @Override // com.google.android.gms.internal.measurement.x3
    public final void a(int i, zzjb zzjbVar) {
        this.a.j(i, zzjbVar);
    }

    @Override // com.google.android.gms.internal.measurement.x3
    public final void b(int i, Object obj, h3 h3Var) {
        b2 b2Var = this.a;
        b2Var.s(i, 3);
        h3Var.c((cef) obj, b2Var.a);
        b2Var.s(i, 4);
    }

    @Override // com.google.android.gms.internal.measurement.x3
    public final void c(int i, Object obj, h3 h3Var) {
        Object obj2 = (cef) obj;
        a2 a2Var = (a2) this.a;
        a2Var.u((i << 3) | 2);
        p1 p1Var = (p1) obj2;
    ...
    public final void zzB(int i, List list, boolean z) {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                b2Var.t(i, (intValue >> 31) ^ (intValue + intValue));
                i2++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            i3 += b2.a((intValue2 >> 31) ^ (intValue2 + intValue2));
        }
        this.a.u(i3);
        while (i2 < list.size()) {
            b2 b2Var2 = this.a;
            int intValue3 = ((Integer) list.get(i2)).intValue();
            b2Var2.u((intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzD(int i, List list, boolean z) {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                b2Var.v(i, (longValue >> 63) ^ (longValue + longValue));
                i2++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            i3 += b2.b((longValue2 >> 63) ^ (longValue2 + longValue2));
        }
        this.a.u(i3);
        while (i2 < list.size()) {
            b2 b2Var2 = this.a;
            long longValue3 = ((Long) list.get(i2)).longValue();
            b2Var2.w((longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
    ...
    public final void zzI(int i, List list, boolean z) {
        ...
        int i3 = 0;
        for (int i4 = 0; i4 < list.size(); i4++) {
            i3 += b2.a(((Integer) list.get(i4)).intValue());
        }
        this.a.u(i3);
        while (i2 < list.size()) {
    ...
    public final void zzK(int i, List list, boolean z) {
        ...
        int i3 = 0;
        for (int i4 = 0; i4 < list.size(); i4++) {
            i3 += b2.b(((Long) list.get(i4)).longValue());
        }
        this.a.u(i3);
        while (i2 < list.size()) {
    ...
    public final void zzj(int i, List list, boolean z) {
        ...
        int i3 = 0;
        for (int i4 = 0; i4 < list.size(); i4++) {
            i3 += b2.z(((Integer) list.get(i4)).intValue());
        }
        this.a.u(i3);
        while (i2 < list.size()) {
