...
public abstract class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    private final og8 zae(int i, TaskApiCall taskApiCall) {
        qg8 qg8Var = new qg8();
        this.zaa.zav(this, i, taskApiCall, qg8Var, this.zaj);
        return qg8Var.a();
    }
    ...
    protected ClientSettings.Builder createClientSettingsBuilder() {
        ...
        if (apiOptions3 instanceof Api.ApiOptions.HasGoogleSignInAccountOptions) {
            ...
            emptySet = googleSignInAccount2 == null ? Collections.emptySet() : googleSignInAccount2.w1();
        } else {
    ...
    @KeepForSdk
    protected og8 disconnectService() {
    ...
    @KeepForSdk
    @Deprecated
    public <A extends Api.AnyClient, T extends RegisterListenerMethod<A, ?>, U extends UnregisterListenerMethod<A, ?>> og8 doRegisterEventListener(T t, U u) {
    ...
    @ResultIgnorabilityUnspecified
    @KeepForSdk
    public og8 doUnregisterEventListener(ListenerHolder.ListenerKey<?> listenerKey) {
    ...
    */
    ...
    @ResultIgnorabilityUnspecified
    @KeepForSdk
    public <TResult, A extends Api.AnyClient> og8 doBestEffortWrite(TaskApiCall<A, TResult> taskApiCall) {
        return zae(2, taskApiCall);
    }

    @ResultIgnorabilityUnspecified
    @KeepForSdk
    public <TResult, A extends Api.AnyClient> og8 doRead(TaskApiCall<A, TResult> taskApiCall) {
        return zae(0, taskApiCall);
    }

    @ResultIgnorabilityUnspecified
    @KeepForSdk
    public og8 doUnregisterEventListener(ListenerHolder.ListenerKey<?> listenerKey, int i) {
    ...
    @ResultIgnorabilityUnspecified
    @KeepForSdk
    public <TResult, A extends Api.AnyClient> og8 doWrite(TaskApiCall<A, TResult> taskApiCall) {
    ...
    @ResultIgnorabilityUnspecified
    @KeepForSdk
    public <A extends Api.AnyClient> og8 doRegisterEventListener(RegistrationMethods<A, ?> registrationMethods) {
