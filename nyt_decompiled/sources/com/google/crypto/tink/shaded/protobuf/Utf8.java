...
abstract class Utf8 {
        ...
        */
        int d(int r6, byte[] r7, int r8, int r9) {
            ...
            L1c:
                ...
                r8 = r7[r8]
                if (r6 < r9) goto L31
                int r5 = com.google.crypto.tink.shaded.protobuf.Utf8.a(r5, r8)
                return r5
            L31:
                r4 = r8
                r8 = r6
            ...
            L49:
                ...
                r0 = r7[r8]
                if (r6 < r9) goto L5a
                int r5 = com.google.crypto.tink.shaded.protobuf.Utf8.a(r5, r0)
                return r5
            L5a:
                r8 = 0
                goto L62
            ...
            L62:
                ...
                r6 = r7[r6]
                if (r8 < r9) goto L6f
                int r5 = com.google.crypto.tink.shaded.protobuf.Utf8.b(r5, r0, r6)
                return r5
            L6f:
                r4 = r8
                r8 = r6
        ...
        */
        private static int f(byte[] r10, long r11, int r13) {
            ...
            L9:
                ...
                if (r13 <= 0) goto L1a
                long r4 = r11 + r2
                byte r1 = com.google.crypto.tink.shaded.protobuf.z0.s(r10, r11)
                if (r1 < 0) goto L19
                int r13 = r13 + (-1)
                r11 = r4
                goto L9
            ...
            L29:
                ...
                if (r1 < r0) goto L39
                long r2 = r2 + r11
                byte r11 = com.google.crypto.tink.shaded.protobuf.z0.s(r10, r11)
                if (r11 <= r6) goto L37
                goto L39
            L37:
                r11 = r2
            ...
            L48:
                int r13 = r13 + (-3)
                long r2 = r2 + r11
                byte r0 = com.google.crypto.tink.shaded.protobuf.z0.s(r10, r11)
                if (r0 > r6) goto L64
                r7 = -96
                if (r1 != r4) goto L57
                if (r0 < r7) goto L64
            ...
            L5d:
                long r11 = r11 + r8
                byte r0 = com.google.crypto.tink.shaded.protobuf.z0.s(r10, r2)
                if (r0 <= r6) goto L7
            L64:
                return r5
            L65:
            ...
            L6d:
                ...
                r0 = 3
                long r11 = r11 + r0
                byte r0 = com.google.crypto.tink.shaded.protobuf.z0.s(r10, r8)
                if (r0 <= r6) goto L7
            L8f:
                return r5
            */
        ...
        private static int h(byte[] bArr, int i, long j, int i2) {
            ...
            if (i2 == 1) {
                return Utf8.j(i, z0.s(bArr, j));
            }
            if (i2 == 2) {
                return Utf8.k(i, z0.s(bArr, j), z0.s(bArr, j + 1));
            }
        ...
        String a(byte[] bArr, int i, int i2) {
            ...
            while (i < i3) {
                ...
                if (a.n(s2)) {
                    ...
                    int i8 = i + 2;
                    i += 3;
                    a.j(s2, z0.s(bArr, i6), z0.s(bArr, i8), cArr, i5);
                    i5++;
                } else {
                    if (i6 >= i3 - 2) {
                        throw InvalidProtocolBufferException.c();
                    }
                    byte s4 = z0.s(bArr, i6);
                    int i9 = i + 3;
                    byte s5 = z0.s(bArr, i + 2);
                    i += 4;
                    a.h(s2, s4, s5, z0.s(bArr, i9), cArr, i5);
                    i5 += 2;
                }
            }
            return new String(cArr, 0, i5);
            ...
            while (i4 < length) {
                ...
                if (charAt2 >= 128 || j4 >= j5) {
                    if (charAt2 >= 2048 || j4 > j5 - 2) {
                        ...
                        if ((charAt2 >= 55296 && 57343 >= charAt2) || j4 > j5 - 3) {
                            ...
                            if (i5 != length) {
                                ...
                                if (Character.isSurrogatePair(charAt2, charAt3)) {
                                    ...
                                    j2 = 1;
                                    z0.H(bArr, j4, (byte) ((codePoint >>> 18) | 240));
                                    j3 = j5;
                                    z0.H(bArr, j4 + 1, (byte) (((codePoint >>> 12) & 63) | 128));
                                    long j6 = j4 + 3;
                                    z0.H(bArr, j4 + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                    j4 += 4;
                                    z0.H(bArr, j6, (byte) ((codePoint & 63) | 128));
                                    i4 = i5;
                                } else {
                                    i4 = i5;
                                }
                        ...
                        z0.H(bArr, j4, (byte) ((charAt2 >>> '\f') | 480));
                        long j7 = j4 + 2;
                        z0.H(bArr, j4 + 1, (byte) (((charAt2 >>> 6) & 63) | 128));
                        j4 += 3;
                        z0.H(bArr, j7, (byte) ((charAt2 & '?') | 128));
                    } else {
                        str = str3;
                        str2 = str4;
                        long j8 = j4 + j;
                        z0.H(bArr, j4, (byte) ((charAt2 >>> 6) | 960));
                        j4 += 2;
                        z0.H(bArr, j8, (byte) ((charAt2 & '?') | 128));
                    }
                    j3 = j5;
                    j2 = 1;
                } else {
                    z0.H(bArr, j4, (byte) charAt2);
                    j3 = j5;
                    str = str3;
                    j2 = j;
                    j4 += j;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:34:0x0058, code lost:
            ...
            if (com.google.crypto.tink.shaded.protobuf.z0.s(r11, r0) > (-65)) goto L38;
         */
        /* JADX WARN: Code restructure failed: missing block: B:55:0x009e, code lost:
        
            if (com.google.crypto.tink.shaded.protobuf.z0.s(r11, r0) > (-65)) goto L59;
         */
        @Override // com.google.crypto.tink.shaded.protobuf.Utf8.b
        /*
            Code decompiled incorrectly, please refer to instructions dump.
    ...
    static {
        a = (!d.e() || com.google.crypto.tink.shaded.protobuf.d.c()) ? new c() : new d();
    }
