...
public final class NumberedArticleTrendingNodeJsonAdapter extends JsonAdapter<NumberedArticleTrendingNode> {
    ...
    public NumberedArticleTrendingNode fromJson(JsonReader jsonReader) {
        ...
        if (i == -65) {
            ...
            if (instant != null) {
                return new NumberedArticleTrendingNode(str, str2, str3, str4, image, instant, bool2.booleanValue());
            }
        ...
        if (constructor == null) {
            constructor = NumberedArticleTrendingNode.class.getDeclaredConstructor(String.class, String.class, String.class, String.class, Image.class, Instant.class, Boolean.TYPE, Integer.TYPE, c29.c);
        ...
        NumberedArticleTrendingNode newInstance = constructor.newInstance(str, str2, str3, str4, image, instant, bool2, Integer.valueOf(i), null);
    ...
    public void mo197toJson(h hVar, NumberedArticleTrendingNode numberedArticleTrendingNode) {
        zq3.h(hVar, "writer");
        ...
        hVar.d();
        hVar.C("uri");
        this.stringAdapter.mo197toJson(hVar, numberedArticleTrendingNode.d());
        hVar.C("url");
        this.stringAdapter.mo197toJson(hVar, numberedArticleTrendingNode.e());
        hVar.C("headline");
        this.stringAdapter.mo197toJson(hVar, numberedArticleTrendingNode.a());
        hVar.C("summary");
        this.stringAdapter.mo197toJson(hVar, numberedArticleTrendingNode.c());
        hVar.C("promoMedia");
        this.nullableImageAdapter.mo197toJson(hVar, numberedArticleTrendingNode.b());
        hVar.C("lastModified");
        this.instantAdapter.mo197toJson(hVar, numberedArticleTrendingNode.g());
        hVar.C("isOpinion");
        this.booleanAdapter.mo197toJson(hVar, Boolean.valueOf(numberedArticleTrendingNode.f()));
        hVar.l();
    }
