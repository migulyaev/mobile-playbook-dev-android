...
public final class NumberedInteractiveTrendingNodeJsonAdapter extends JsonAdapter<NumberedInteractiveTrendingNode> {
    ...
    public NumberedInteractiveTrendingNode fromJson(JsonReader jsonReader) {
        ...
        if (constructor == null) {
            constructor = NumberedInteractiveTrendingNode.class.getDeclaredConstructor(String.class, String.class, String.class, String.class, Image.class, Instant.class, Boolean.TYPE, Integer.TYPE, c29.c);
    ...
    public void mo197toJson(h hVar, NumberedInteractiveTrendingNode numberedInteractiveTrendingNode) {
        zq3.h(hVar, "writer");
        ...
        hVar.d();
        hVar.C("uri");
        this.stringAdapter.mo197toJson(hVar, numberedInteractiveTrendingNode.d());
        hVar.C("url");
        this.stringAdapter.mo197toJson(hVar, numberedInteractiveTrendingNode.e());
        hVar.C("headline");
        this.stringAdapter.mo197toJson(hVar, numberedInteractiveTrendingNode.a());
        hVar.C("summary");
        this.stringAdapter.mo197toJson(hVar, numberedInteractiveTrendingNode.c());
        hVar.C("promoMedia");
        this.nullableImageAdapter.mo197toJson(hVar, numberedInteractiveTrendingNode.b());
        hVar.C("lastModified");
        this.instantAdapter.mo197toJson(hVar, numberedInteractiveTrendingNode.g());
        hVar.C("isOpinion");
        this.booleanAdapter.mo197toJson(hVar, Boolean.valueOf(numberedInteractiveTrendingNode.f()));
        hVar.l();
    }
