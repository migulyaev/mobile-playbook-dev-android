...
public final class Interest$NewsletterInterest$$serializer implements jx2 {
    public static final Interest$NewsletterInterest$$serializer INSTANCE;
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        Interest$NewsletterInterest$$serializer interest$NewsletterInterest$$serializer = new Interest$NewsletterInterest$$serializer();
        INSTANCE = interest$NewsletterInterest$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.nytimes.android.interests.db.Interest.NewsletterInterest", interest$NewsletterInterest$$serializer, 11);
    ...
    private Interest$NewsletterInterest$$serializer() {
    }

    @Override // defpackage.jx2
    public KSerializer[] childSerializers() {
        KSerializer[] kSerializerArr;
        kSerializerArr = Interest.NewsletterInterest.m;
    ...
    public Interest.NewsletterInterest deserialize(Decoder decoder) {
        KSerializer[] kSerializerArr;
        boolean z;
        List list;
        ...
        b.c(descriptor2);
        return new Interest.NewsletterInterest(i, str, str2, str3, str4, str5, str6, z, promotionalMedia, str7, str8, list, null);
    }
    ...
    public void serialize(Encoder encoder, Interest.NewsletterInterest newsletterInterest) {
        zq3.h(encoder, "encoder");
        zq3.h(newsletterInterest, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        d b = encoder.b(descriptor2);
        Interest.NewsletterInterest.f(newsletterInterest, b, descriptor2);
        b.c(descriptor2);
    }
