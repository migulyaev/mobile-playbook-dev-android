...
public final class InterestInteractiveAsset$$serializer implements jx2 {
    public static final InterestInteractiveAsset$$serializer INSTANCE;
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        InterestInteractiveAsset$$serializer interestInteractiveAsset$$serializer = new InterestInteractiveAsset$$serializer();
        INSTANCE = interestInteractiveAsset$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.nytimes.android.interests.db.InterestInteractiveAsset", interestInteractiveAsset$$serializer, 9);
    ...
    private InterestInteractiveAsset$$serializer() {
    }
    ...
    public InterestInteractiveAsset deserialize(Decoder decoder) {
        boolean z;
        int i;
        ...
        b.c(descriptor2);
        return new InterestInteractiveAsset(i, str, str2, str3, str4, str5, promotionalMedia, j2, j, z, null);
    }
    ...
    public void serialize(Encoder encoder, InterestInteractiveAsset interestInteractiveAsset) {
        zq3.h(encoder, "encoder");
        zq3.h(interestInteractiveAsset, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        d b = encoder.b(descriptor2);
        InterestInteractiveAsset.s(interestInteractiveAsset, b, descriptor2);
        b.c(descriptor2);
    }
