...
@fc1(c = "com.nytimes.android.ribbon.destinations.cooking.CookingViewModel$refreshCookingAssets$1", f = "CookingViewModel.kt", l = {66}, m = "invokeSuspend")
/* loaded from: classes4.dex */
final class CookingViewModel$refreshCookingAssets$1 extends SuspendLambda implements gt2 {
    final /* synthetic */ CookingViewState $data;
    final /* synthetic */ boolean $forceRefresh;
    int label;
    final /* synthetic */ CookingViewModel this$0;

    @fc1(c = "com.nytimes.android.ribbon.destinations.cooking.CookingViewModel$refreshCookingAssets$1$1", f = "CookingViewModel.kt", l = {}, m = "invokeSuspend")
    /* renamed from: com.nytimes.android.ribbon.destinations.cooking.CookingViewModel$refreshCookingAssets$1$1, reason: invalid class name */
    ...
    static final class a implements FlowCollector {
        final /* synthetic */ CookingViewModel a;

        a(CookingViewModel cookingViewModel) {
            this.a = cookingViewModel;
        }
    ...
    CookingViewModel$refreshCookingAssets$1(CookingViewModel cookingViewModel, boolean z, CookingViewState cookingViewState, by0 by0Var) {
        super(2, by0Var);
        this.this$0 = cookingViewModel;
        this.$forceRefresh = z;
        this.$data = cookingViewState;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final by0 create(Object obj, by0 by0Var) {
        return new CookingViewModel$refreshCookingAssets$1(this.this$0, this.$forceRefresh, this.$data, by0Var);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            f.b(obj);
            cachedParallelStore = this.this$0.i;
    ...
    public final Object invoke(CoroutineScope coroutineScope, by0 by0Var) {
        return ((CookingViewModel$refreshCookingAssets$1) create(coroutineScope, by0Var)).invokeSuspend(ww8.a);
    }
}
