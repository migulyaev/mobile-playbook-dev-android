...
public final class ContentSeriesJsonAdapter extends JsonAdapter<ContentSeries> {
    ...
    public ContentSeries fromJson(JsonReader jsonReader) {
        ...
        if (constructor == null) {
            constructor = ContentSeries.class.getDeclaredConstructor(String.class, String.class, Integer.TYPE, c29.c);
    ...
    public void mo197toJson(h hVar, ContentSeries contentSeries) {
        zq3.h(hVar, "writer");
        ...
        this.nullableStringAdapter.mo197toJson(hVar, contentSeries.getName());
        hVar.C("displayName");
        this.nullableStringAdapter.mo197toJson(hVar, contentSeries.getDisplayName());
        hVar.l();
    }
}
