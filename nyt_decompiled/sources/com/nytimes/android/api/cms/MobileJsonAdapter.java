...
public final class MobileJsonAdapter extends JsonAdapter<Mobile> {
    ...
    public Mobile fromJson(JsonReader jsonReader) {
        ...
        if (constructor == null) {
            ...
            constructor = Mobile.class.getDeclaredConstructor(cls, cls, String.class, Integer.TYPE, c29.c);
    ...
    public void mo197toJson(h hVar, Mobile mobile) {
        zq3.h(hVar, "writer");
        if (mobile == null) {
        ...
        hVar.d();
        hVar.C("embedded");
        this.booleanAdapter.mo197toJson(hVar, Boolean.valueOf(mobile.getEmbedded()));
        hVar.C("includeInCompatibleApps");
        this.booleanAdapter.mo197toJson(hVar, Boolean.valueOf(mobile.getIncludeInCompatibleApps()));
        hVar.C("url");
        this.nullableStringAdapter.mo197toJson(hVar, mobile.getUrl());
        hVar.l();
    }
}
