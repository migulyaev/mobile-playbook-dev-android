...
public final class GraphQlInteractiveAssetJsonAdapter extends JsonAdapter<GraphQlInteractiveAsset> {
    ...
    public GraphQlInteractiveAssetJsonAdapter(i iVar) {
        zq3.h(iVar, "moshi");
        ...
        JsonAdapter<Interactivegraphics> f2 = iVar.f(Interactivegraphics.class, b0.e(), AssetConstants.INTERACTIVE_GRAPHICS_TYPE);
        zq3.g(f2, "adapter(...)");
    ...
    public GraphQlInteractiveAsset fromJson(JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (P == -1) {
                ...
                interactivegraphics = (Interactivegraphics) this.nullableInteractivegraphicsAdapter.fromJson(jsonReader);
                i = -3;
            }
        }
        jsonReader.h();
        ...
        if (constructor == null) {
            constructor = GraphQlInteractiveAsset.class.getDeclaredConstructor(AssetData.class, Interactivegraphics.class, Integer.TYPE, c29.c);
            this.constructorRef = constructor;
            zq3.g(constructor, "also(...)");
        }
        if (assetData != null) {
            GraphQlInteractiveAsset newInstance = constructor.newInstance(assetData, interactivegraphics, Integer.valueOf(i), null);
    ...
    public void mo197toJson(h hVar, GraphQlInteractiveAsset graphQlInteractiveAsset) {
        zq3.h(hVar, "writer");
        if (graphQlInteractiveAsset == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        hVar.d();
        hVar.C("assetData");
        this.assetDataAdapter.mo197toJson(hVar, graphQlInteractiveAsset.getAssetData());
        hVar.C(AssetConstants.INTERACTIVE_GRAPHICS_TYPE);
        this.nullableInteractivegraphicsAdapter.mo197toJson(hVar, graphQlInteractiveAsset.getInteractivegraphics());
        hVar.l();
    }
}
