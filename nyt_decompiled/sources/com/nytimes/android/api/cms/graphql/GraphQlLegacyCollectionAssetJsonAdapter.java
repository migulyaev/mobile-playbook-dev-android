...
public final class GraphQlLegacyCollectionAssetJsonAdapter extends JsonAdapter<GraphQlLegacyCollectionAsset> {
    ...
    public GraphQlLegacyCollectionAssetJsonAdapter(i iVar) {
        ...
        JsonAdapter<LegacyCollectionGraphics> f2 = iVar.f(LegacyCollectionGraphics.class, b0.e(), AssetConstants.INTERACTIVE_GRAPHICS_TYPE);
        zq3.g(f2, "adapter(...)");
    ...
    public GraphQlLegacyCollectionAsset fromJson(JsonReader jsonReader) {
        ...
        if (constructor == null) {
            constructor = GraphQlLegacyCollectionAsset.class.getDeclaredConstructor(AssetData.class, LegacyCollectionGraphics.class, Integer.TYPE, c29.c);
            this.constructorRef = constructor;
            zq3.g(constructor, "also(...)");
        }
        if (assetData != null) {
            GraphQlLegacyCollectionAsset newInstance = constructor.newInstance(assetData, legacyCollectionGraphics, Integer.valueOf(i), null);
    ...
    public void mo197toJson(h hVar, GraphQlLegacyCollectionAsset graphQlLegacyCollectionAsset) {
        zq3.h(hVar, "writer");
        ...
        hVar.d();
        hVar.C("assetData");
        this.assetDataAdapter.mo197toJson(hVar, graphQlLegacyCollectionAsset.getAssetData());
        hVar.C(AssetConstants.INTERACTIVE_GRAPHICS_TYPE);
        this.nullableLegacyCollectionGraphicsAdapter.mo197toJson(hVar, graphQlLegacyCollectionAsset.getInteractivegraphics());
        hVar.l();
    }
}
