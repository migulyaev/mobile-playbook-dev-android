...
public final class GraphQlImageAsset implements ImageAsset, Asset {
    private final AssetData assetData;
    private final Image image;

    public GraphQlImageAsset(AssetData assetData, Image image) {
        zq3.h(assetData, "assetData");
        this.assetData = assetData;
        this.image = image;
    }

    public static /* synthetic */ GraphQlImageAsset copy$default(GraphQlImageAsset graphQlImageAsset, AssetData assetData, Image image, int i, Object obj) {
        if ((i & 1) != 0) {
            assetData = graphQlImageAsset.assetData;
        }
        if ((i & 2) != 0) {
            image = graphQlImageAsset.image;
        }
        return graphQlImageAsset.copy(assetData, image);
    }
    ...
    public final GraphQlImageAsset copy(AssetData assetData, Image image) {
        zq3.h(assetData, "assetData");
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof GraphQlImageAsset)) {
            return false;
        }
        GraphQlImageAsset graphQlImageAsset = (GraphQlImageAsset) obj;
        return zq3.c(this.assetData, graphQlImageAsset.assetData) && zq3.c(this.image, graphQlImageAsset.image);
    }
    ...
    public String toString() {
        return "GraphQlImageAsset(assetData=" + this.assetData + ", image=" + this.image + ")";
    }
    ...
    public /* synthetic */ GraphQlImageAsset(AssetData assetData, Image image, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(assetData, (i & 2) != 0 ? null : image);
    }
}
