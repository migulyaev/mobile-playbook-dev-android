...
public final class GraphQlSlideshowAsset implements SlideshowAsset, Asset {
    private final AssetData assetData;
    private final Slideshow slideshow;

    public GraphQlSlideshowAsset(AssetData assetData, Slideshow slideshow) {
        zq3.h(assetData, "assetData");
        this.assetData = assetData;
        this.slideshow = slideshow;
    }

    public static /* synthetic */ GraphQlSlideshowAsset copy$default(GraphQlSlideshowAsset graphQlSlideshowAsset, AssetData assetData, Slideshow slideshow, int i, Object obj) {
        if ((i & 1) != 0) {
            assetData = graphQlSlideshowAsset.assetData;
        }
        if ((i & 2) != 0) {
            slideshow = graphQlSlideshowAsset.slideshow;
        }
        return graphQlSlideshowAsset.copy(assetData, slideshow);
    }
    ...
    public final GraphQlSlideshowAsset copy(AssetData assetData, Slideshow slideshow) {
        zq3.h(assetData, "assetData");
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof GraphQlSlideshowAsset)) {
            return false;
        }
        GraphQlSlideshowAsset graphQlSlideshowAsset = (GraphQlSlideshowAsset) obj;
        return zq3.c(this.assetData, graphQlSlideshowAsset.assetData) && zq3.c(this.slideshow, graphQlSlideshowAsset.slideshow);
    }
    ...
    public int hashCode() {
        ...
        return hashCode + (slideshow == null ? 0 : slideshow.hashCode());
    }
    ...
    public String toString() {
        return "GraphQlSlideshowAsset(assetData=" + this.assetData + ", slideshow=" + this.slideshow + ")";
    }
    ...
    public /* synthetic */ GraphQlSlideshowAsset(AssetData assetData, Slideshow slideshow, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(assetData, (i & 2) != 0 ? null : slideshow);
    }
}
