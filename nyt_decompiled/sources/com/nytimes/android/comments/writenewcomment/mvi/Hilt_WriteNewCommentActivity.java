...
public abstract class Hilt_WriteNewCommentActivity extends jk implements ix2 {
    private volatile m4 componentManager;
    private final Object componentManagerLock;
    private boolean injected;
    private w97 savedStateHandleHolder;

    Hilt_WriteNewCommentActivity() {
    ...
    private void _initHiltInternal() {
        addOnContextAvailableListener(new pe5() { // from class: com.nytimes.android.comments.writenewcomment.mvi.Hilt_WriteNewCommentActivity.1
    ...
    protected void inject() {
        ...
        this.injected = true;
        ((WriteNewCommentActivity_GeneratedInjector) generatedComponent()).injectWriteNewCommentActivity((WriteNewCommentActivity) nx8.a(this));
    }
