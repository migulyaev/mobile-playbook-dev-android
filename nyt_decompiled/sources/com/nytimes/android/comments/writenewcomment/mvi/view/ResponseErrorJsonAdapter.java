...
import com.nytimes.android.comments.writenewcomment.mvi.view.ResponseError;
...
public final class ResponseErrorJsonAdapter extends JsonAdapter<ResponseError> {
    ...
    public void mo197toJson(h hVar, ResponseError responseError) {
        ...
        hVar.d();
        hVar.C("status");
        this.nullableStringAdapter.mo197toJson(hVar, responseError.getStatus());
        hVar.C("results");
        this.nullableResultsAdapter.mo197toJson(hVar, responseError.getResults());
        hVar.C("errorDetails");
        this.nullableStringAdapter.mo197toJson(hVar, responseError.getErrorDetails());
        hVar.l();
    }
}
