...
public final class PostAuthSkuOverrideDataJsonAdapter extends JsonAdapter<PostAuthSkuOverrideData> {
    ...
    public PostAuthSkuOverrideData fromJson(JsonReader jsonReader) {
        ...
        if (constructor == null) {
            Class cls = Long.TYPE;
            constructor = PostAuthSkuOverrideData.class.getDeclaredConstructor(cls, cls, String.class, Integer.TYPE, c29.c);
    ...
    public void mo197toJson(h hVar, PostAuthSkuOverrideData postAuthSkuOverrideData) {
        zq3.h(hVar, "writer");
        ...
        this.longAdapter.mo197toJson(hVar, Long.valueOf(postAuthSkuOverrideData.getStartTimeInterval()));
        hVar.C("endTimeInterval");
        this.longAdapter.mo197toJson(hVar, Long.valueOf(postAuthSkuOverrideData.getEndTimeInterval()));
        hVar.C("sku");
        this.stringAdapter.mo197toJson(hVar, postAuthSkuOverrideData.a());
        hVar.l();
    }
