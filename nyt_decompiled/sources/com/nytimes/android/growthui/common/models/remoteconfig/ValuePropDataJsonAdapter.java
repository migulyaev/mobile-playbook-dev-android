...
public final class ValuePropDataJsonAdapter extends JsonAdapter<ValuePropData> {
    ...
    public ValuePropData fromJson(JsonReader jsonReader) {
        ...
        if (constructor == null) {
            constructor = ValuePropData.class.getDeclaredConstructor(String.class, String.class, String.class, Integer.TYPE, c29.c);
    ...
    public void mo197toJson(h hVar, ValuePropData valuePropData) {
        zq3.h(hVar, "writer");
        ...
        hVar.d();
        hVar.C("title");
        this.stringAdapter.mo197toJson(hVar, valuePropData.c());
        hVar.C("text");
        this.stringAdapter.mo197toJson(hVar, valuePropData.b());
        hVar.C("icon");
        this.stringAdapter.mo197toJson(hVar, valuePropData.a());
        hVar.l();
    }
