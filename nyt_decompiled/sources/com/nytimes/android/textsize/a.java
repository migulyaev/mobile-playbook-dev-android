...
public abstract class a extends BaseAppCompatActivity implements ix2 {
    ...
    /* renamed from: com.nytimes.android.textsize.a$a, reason: collision with other inner class name */
    class C0439a implements pe5 {
        C0439a() {
        }
    ...
    private void _initHiltInternal() {
        addOnContextAvailableListener(new C0439a());
    }
    ...
    protected void inject() {
        ...
        this.d = true;
        ((vj8) generatedComponent()).g((TextSizeActivity) nx8.a(this));
    }
