...
public abstract class a extends BaseAppCompatActivity implements ix2 {
    ...
    /* renamed from: com.nytimes.android.features.giftsharehub.a$a, reason: collision with other inner class name */
    class C0283a implements pe5 {
        C0283a() {
        }
    ...
    protected void inject() {
        ...
        this.d = true;
        ((f03) generatedComponent()).k0((GiftShareHubActivity) nx8.a(this));
    }
