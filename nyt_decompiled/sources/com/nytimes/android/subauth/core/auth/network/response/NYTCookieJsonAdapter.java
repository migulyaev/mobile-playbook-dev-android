...
public final class NYTCookieJsonAdapter extends JsonAdapter<NYTCookie> {
    ...
    public NYTCookieJsonAdapter(i iVar) {
        zq3.h(iVar, "moshi");
        JsonReader.b a = JsonReader.b.a("cipheredValue", AuthenticationTokenClaims.JSON_KEY_NAME);
        zq3.g(a, "of(...)");
        this.options = a;
    ...
    public NYTCookie fromJson(JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (P == -1) {
                ...
                if (str == null) {
                    JsonDataException x = c29.x("value__", "cipheredValue", jsonReader);
        ...
        jsonReader.h();
        if (str == null) {
            JsonDataException o = c29.o("value__", "cipheredValue", jsonReader);
    ...
    public void mo197toJson(h hVar, NYTCookie nYTCookie) {
        zq3.h(hVar, "writer");
        if (nYTCookie == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        hVar.d();
        hVar.C("cipheredValue");
        this.stringAdapter.mo197toJson(hVar, nYTCookie.b());
        hVar.C(AuthenticationTokenClaims.JSON_KEY_NAME);
        this.stringAdapter.mo197toJson(hVar, nYTCookie.a());
        hVar.l();
    }
