...
public final class ShowCaliforniaNoticesUiDirectiveJsonAdapter extends JsonAdapter<ShowCaliforniaNoticesUiDirective> {
    private final JsonReader.b options;
    private final JsonAdapter<ToggleableDirectiveValue> toggleableDirectiveValueAdapter;

    public ShowCaliforniaNoticesUiDirectiveJsonAdapter(i iVar) {
        zq3.h(iVar, "moshi");
    ...
    public String toString() {
        ...
        sb.append("ShowCaliforniaNoticesUiDirective");
        sb.append(')');
    ...
    public ShowCaliforniaNoticesUiDirective fromJson(JsonReader jsonReader) {
    ...
    public void mo197toJson(h hVar, ShowCaliforniaNoticesUiDirective showCaliforniaNoticesUiDirective) {
        zq3.h(hVar, "writer");
        ...
        hVar.d();
        hVar.C("value");
        this.toggleableDirectiveValueAdapter.mo197toJson(hVar, showCaliforniaNoticesUiDirective.getValue());
        hVar.l();
    }
}
