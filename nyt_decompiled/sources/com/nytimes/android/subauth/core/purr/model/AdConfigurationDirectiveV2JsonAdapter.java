...
public final class AdConfigurationDirectiveV2JsonAdapter extends JsonAdapter<AdConfigurationDirectiveV2> {
    ...
    public void mo197toJson(h hVar, AdConfigurationDirectiveV2 adConfigurationDirectiveV2) {
        zq3.h(hVar, "writer");
        ...
        hVar.d();
        hVar.C("value");
        this.adConfigurationAdapter.mo197toJson(hVar, adConfigurationDirectiveV2.getValue());
        hVar.l();
    }
}
