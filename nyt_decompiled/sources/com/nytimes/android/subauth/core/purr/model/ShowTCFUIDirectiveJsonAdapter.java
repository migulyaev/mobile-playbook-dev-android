...
public final class ShowTCFUIDirectiveJsonAdapter extends JsonAdapter<ShowTCFUIDirective> {
    private final JsonReader.b options;
    private final JsonAdapter<ToggleableDirectiveValue> toggleableDirectiveValueAdapter;

    public ShowTCFUIDirectiveJsonAdapter(i iVar) {
        zq3.h(iVar, "moshi");
    ...
    public ShowTCFUIDirective fromJson(JsonReader jsonReader) {
    ...
    public void mo197toJson(h hVar, ShowTCFUIDirective showTCFUIDirective) {
        zq3.h(hVar, "writer");
        ...
        hVar.d();
        hVar.C("value");
        this.toggleableDirectiveValueAdapter.mo197toJson(hVar, showTCFUIDirective.getValue());
        hVar.l();
    }
}
