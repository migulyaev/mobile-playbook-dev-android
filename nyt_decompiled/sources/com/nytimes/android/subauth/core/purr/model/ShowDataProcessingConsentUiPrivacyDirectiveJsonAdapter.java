...
public final class ShowDataProcessingConsentUiPrivacyDirectiveJsonAdapter extends JsonAdapter<ShowDataProcessingConsentUiPrivacyDirective> {
    private final JsonReader.b options;
    private final JsonAdapter<ToggleableDirectiveValue> toggleableDirectiveValueAdapter;

    public ShowDataProcessingConsentUiPrivacyDirectiveJsonAdapter(i iVar) {
        zq3.h(iVar, "moshi");
    ...
    public String toString() {
        ...
        sb.append("ShowDataProcessingConsentUiPrivacyDirective");
        sb.append(')');
    ...
    public ShowDataProcessingConsentUiPrivacyDirective fromJson(JsonReader jsonReader) {
    ...
    public void mo197toJson(h hVar, ShowDataProcessingConsentUiPrivacyDirective showDataProcessingConsentUiPrivacyDirective) {
        zq3.h(hVar, "writer");
        ...
        hVar.d();
        hVar.C("value");
        this.toggleableDirectiveValueAdapter.mo197toJson(hVar, showDataProcessingConsentUiPrivacyDirective.getValue());
        hVar.l();
    }
}
