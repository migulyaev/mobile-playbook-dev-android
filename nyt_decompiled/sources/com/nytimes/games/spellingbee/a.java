...
public abstract class a extends BaseGamesHybridHostActivity implements ix2 {
    private w97 a;
    ...
    private void _initHiltInternal() {
        addOnContextAvailableListener(new C0445a());
    }
    ...
    protected void inject() {
        ...
        this.d = true;
        ((uy7) generatedComponent()).f0((SpellingBeeHostActivity) nx8.a(this));
    }
