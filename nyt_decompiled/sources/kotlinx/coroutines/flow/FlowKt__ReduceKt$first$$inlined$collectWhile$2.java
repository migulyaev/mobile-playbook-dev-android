...
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @fc1(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2", f = "Reduce.kt", l = {139}, m = "emit")
    ...
    public FlowKt__ReduceKt$first$$inlined$collectWhile$2(gt2 gt2Var, Ref$ObjectRef ref$ObjectRef) {
    ...
    */
    public java.lang.Object emit(T r5, defpackage.by0<? super defpackage.ww8> r6) {
        ...
        L5c:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2.emit(java.lang.Object, by0):java.lang.Object");
    }
}
