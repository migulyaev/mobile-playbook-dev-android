...
public final class FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @fc1(c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1", f = "Errors.kt", l = {ContentType.LONG_FORM_ON_DEMAND, ContentType.LIVE}, m = "collect")
    ...
    public FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1(Flow flow, it2 it2Var) {
    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r6, defpackage.by0<? super defpackage.ww8> r7) {
        ...
        L6f:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1.collect(kotlinx.coroutines.flow.FlowCollector, by0):java.lang.Object");
    }
}
