    ...
    static final class PartMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        public void apply(RequestBuilder requestBuilder, Map<String, T> map) throws IOException {
            ...
            for (Map.Entry<String, T> entry : map.entrySet()) {
                ...
                requestBuilder.addPart(okhttp3.Headers.of(com.amazonaws.services.s3.Headers.CONTENT_DISPOSITION, "form-data; name=\"" + key + "\"", "Content-Transfer-Encoding", this.transferEncoding), this.valueConverter.convert(value));
            }
        }
    }
