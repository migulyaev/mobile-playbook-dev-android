...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public Object f() {
        if (this.mStateFwk == null) {
            ...
            b.x(d2, this.mState, this.mPosition, this.mSpeed, this.mUpdateTime);
            b.u(d2, this.mBufferedPosition);
            b.s(d2, this.mActions);
            b.v(d2, this.mErrorMessage);
            Iterator<CustomAction> it2 = this.mCustomActions.iterator();
            while (it2.hasNext()) {
                b.a(d2, (PlaybackState.CustomAction) it2.next().b());
            }
            b.t(d2, this.mActiveItemId);
            c.b(d2, this.mExtras);
            this.mStateFwk = b.c(d2);
        }
    ...
    public static final class d {
        ...
        public d e(int i, long j, float f) {
            return f(i, j, f, SystemClock.elapsedRealtime());
        }

        public d f(int i, long j, float f, long j2) {
            this.b = i;
            this.c = j;
            this.i = j2;
            this.e = f;
    ...
    public static final class CustomAction implements Parcelable {
        ...
        public Object b() {
            ...
            PlaybackState.CustomAction.Builder e = b.e(this.mAction, this.mName, this.mIcon);
            b.w(e, this.mExtras);
            return b.b(e);
        }
