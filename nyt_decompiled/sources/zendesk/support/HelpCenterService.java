...
interface HelpCenterService {
    ...
    Call<Object> getCategories(@Path("locale") String str);

    @GET("/api/v2/help_center/{locale}/categories/{category_id}.json")
    Call<Object> getCategoryById(@Path("locale") String str, @Path("category_id") Long l);
    ...
    Call<Object> getSectionById(@Path("locale") String str, @Path("section_id") Long l);

    @GET("/api/v2/help_center/{locale}/categories/{id}/sections.json")
    Call<Object> getSections(@Path("locale") String str, @Path("id") Long l, @Query("per_page") int i);

    @GET("/api/mobile/help_center/search/deflect.json?respect_sanitization_settings=true")
    Call<Object> getSuggestedArticles(@Query("query") String str, @Query("locale") String str2, @Query("label_names") String str3, @Query("category") Long l, @Query("section") Long l2);
