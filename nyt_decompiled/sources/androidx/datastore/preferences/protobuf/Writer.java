...
interface Writer {
    ...
    void J(int i, List list, r0 r0Var);

    void K(int i, ByteString byteString);

    void L(int i, Object obj, r0 r0Var);

    void M(int i, z.a aVar, Map map);

    void N(int i, Object obj, r0 r0Var);

    void O(int i, List list, r0 r0Var);
