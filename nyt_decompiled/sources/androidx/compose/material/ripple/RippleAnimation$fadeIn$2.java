...
@fc1(c = "androidx.compose.material.ripple.RippleAnimation$fadeIn$2", f = "RippleAnimation.kt", l = {}, m = "invokeSuspend")
/* loaded from: classes.dex */
final class RippleAnimation$fadeIn$2 extends SuspendLambda implements gt2 {
    private /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ RippleAnimation this$0;

    @fc1(c = "androidx.compose.material.ripple.RippleAnimation$fadeIn$2$1", f = "RippleAnimation.kt", l = {89}, m = "invokeSuspend")
    ...
    @fc1(c = "androidx.compose.material.ripple.RippleAnimation$fadeIn$2$2", f = "RippleAnimation.kt", l = {95}, m = "invokeSuspend")
    ...
    static final class AnonymousClass2 extends SuspendLambda implements gt2 {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass2(RippleAnimation rippleAnimation, by0 by0Var) {
            super(2, by0Var);
            this.this$0 = rippleAnimation;
        }
    ...
    @fc1(c = "androidx.compose.material.ripple.RippleAnimation$fadeIn$2$3", f = "RippleAnimation.kt", l = {101}, m = "invokeSuspend")
    ...
    static final class AnonymousClass3 extends SuspendLambda implements gt2 {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass3(RippleAnimation rippleAnimation, by0 by0Var) {
            super(2, by0Var);
            this.this$0 = rippleAnimation;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final by0 create(Object obj, by0 by0Var) {
            return new AnonymousClass3(this.this$0, by0Var);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                f.b(obj);
                animatable = this.this$0.i;
                Float b = cc0.b(1.0f);
                eu8 k = di.k(225, 0, xx1.d(), 2, null);
                this.label = 1;
                if (Animatable.f(animatable, b, k, null, null, this, 12, null) == h) {
                    return h;
                }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    RippleAnimation$fadeIn$2(RippleAnimation rippleAnimation, by0 by0Var) {
        super(2, by0Var);
        this.this$0 = rippleAnimation;
    }
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final by0 create(Object obj, by0 by0Var) {
        RippleAnimation$fadeIn$2 rippleAnimation$fadeIn$2 = new RippleAnimation$fadeIn$2(this.this$0, by0Var);
    ...
    @Override // defpackage.gt2
    public final Object invoke(CoroutineScope coroutineScope, by0 by0Var) {
        return ((RippleAnimation$fadeIn$2) create(coroutineScope, by0Var)).invokeSuspend(ww8.a);
    }
}
