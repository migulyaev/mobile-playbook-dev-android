...
@fc1(c = "androidx.compose.material.SwitchKt$SwitchImpl$1$1", f = "Switch.kt", l = {224}, m = "invokeSuspend")
/* loaded from: classes.dex */
final class SwitchKt$SwitchImpl$1$1 extends SuspendLambda implements gt2 {
    ...
    static final class a implements FlowCollector {
        ...
        public final Object emit(bo3 bo3Var, by0 by0Var) {
            if (bo3Var instanceof e26) {
                ...
                this.a.remove(((pu1) bo3Var).a());
            } else if (bo3Var instanceof nu1) {
                this.a.remove(((nu1) bo3Var).a());
            }
            return ww8.a;
        }
    }
    ...
    SwitchKt$SwitchImpl$1$1(eo3 eo3Var, SnapshotStateList snapshotStateList, by0 by0Var) {
        super(2, by0Var);
    ...
    public final by0 create(Object obj, by0 by0Var) {
        return new SwitchKt$SwitchImpl$1$1(this.$interactionSource, this.$interactions, by0Var);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, by0 by0Var) {
        return ((SwitchKt$SwitchImpl$1$1) create(coroutineScope, by0Var)).invokeSuspend(ww8.a);
    }
}
