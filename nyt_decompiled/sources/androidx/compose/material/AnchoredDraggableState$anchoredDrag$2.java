...
@fc1(c = "androidx.compose.material.AnchoredDraggableState$anchoredDrag$2", f = "AnchoredDraggable.kt", l = {530}, m = "invokeSuspend")
...
final class AnchoredDraggableState$anchoredDrag$2 extends SuspendLambda implements ss2 {
    ...
    @fc1(c = "androidx.compose.material.AnchoredDraggableState$anchoredDrag$2$2", f = "AnchoredDraggable.kt", l = {531}, m = "invokeSuspend")
    ...
    static final class AnonymousClass2 extends SuspendLambda implements gt2 {
        ...
        public final Object invoke(su1 su1Var, by0 by0Var) {
            return ((AnonymousClass2) create(su1Var, by0Var)).invokeSuspend(ww8.a);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                kotlin.f.b(obj);
                su1 su1Var = (su1) this.L$0;
                it2 it2Var = this.$block;
                jdVar = this.this$0.o;
                this.label = 1;
                if (it2Var.invoke(jdVar, su1Var, this) == h) {
                    return h;
                }
            } else {
                if (i != 1) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            qs2 qs2Var = new qs2() { // from class: androidx.compose.material.AnchoredDraggableState$anchoredDrag$2.1
                {
                    super(0);
                }
                ...
                /* renamed from: b, reason: merged with bridge method [inline-methods] */
                public final su1 mo865invoke() {
                    return AnchoredDraggableState.this.n();
                }
            };
            AnonymousClass2 anonymousClass2 = new AnonymousClass2(this.$block, this.this$0, null);
            this.label = 1;
            i = AnchoredDraggableKt.i(qs2Var, anonymousClass2, this);
            if (i == h) {
                return h;
            }
        } else {
