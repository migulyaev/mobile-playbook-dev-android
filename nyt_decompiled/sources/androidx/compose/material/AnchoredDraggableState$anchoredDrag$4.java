...
@fc1(c = "androidx.compose.material.AnchoredDraggableState$anchoredDrag$4", f = "AnchoredDraggable.kt", l = {577}, m = "invokeSuspend")
...
final class AnchoredDraggableState$anchoredDrag$4 extends SuspendLambda implements ss2 {
    ...
    @fc1(c = "androidx.compose.material.AnchoredDraggableState$anchoredDrag$4$2", f = "AnchoredDraggable.kt", l = {580}, m = "invokeSuspend")
    ...
    static final class AnonymousClass2 extends SuspendLambda implements gt2 {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                su1 su1Var = (su1) pair.a();
                Object b = pair.b();
                kt2 kt2Var = this.$block;
                jdVar = this.this$0.o;
                this.label = 1;
                if (kt2Var.invoke(jdVar, su1Var, b, this) == h) {
                    return h;
                }
            } else {
                if (i != 1) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            qs2 qs2Var = new qs2() { // from class: androidx.compose.material.AnchoredDraggableState$anchoredDrag$4.1
                {
                    super(0);
                }
                ...
                public final Pair mo865invoke() {
                    return du8.a(AnchoredDraggableState.this.n(), AnchoredDraggableState.this.w());
                }
            };
