...
@fc1(c = "androidx.compose.foundation.gestures.MouseWheelScrollNode$1$1$2$1$1", f = "Scrollable.kt", l = {684}, m = "invokeSuspend")
/* loaded from: classes.dex */
final class MouseWheelScrollNode$1$1$2$1$1 extends SuspendLambda implements gt2 {
    final /* synthetic */ long $scrollAmount;
    final /* synthetic */ ScrollingLogic $this_with;
    int label;

    @fc1(c = "androidx.compose.foundation.gestures.MouseWheelScrollNode$1$1$2$1$1$1", f = "Scrollable.kt", l = {}, m = "invokeSuspend")
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    MouseWheelScrollNode$1$1$2$1$1(ScrollingLogic scrollingLogic, long j, by0 by0Var) {
        super(2, by0Var);
        this.$this_with = scrollingLogic;
        this.$scrollAmount = j;
    }
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final by0 create(Object obj, by0 by0Var) {
        return new MouseWheelScrollNode$1$1$2$1$1(this.$this_with, this.$scrollAmount, by0Var);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, by0 by0Var) {
        return ((MouseWheelScrollNode$1$1$2$1$1) create(coroutineScope, by0Var)).invokeSuspend(ww8.a);
    }
}
