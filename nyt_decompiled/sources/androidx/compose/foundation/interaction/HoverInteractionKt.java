...
public abstract class HoverInteractionKt {
    public static final x08 a(eo3 eo3Var, Composer composer, int i) {
        ...
        if (b.G()) {
            b.S(1206586544, i, -1, "androidx.compose.foundation.interaction.collectIsHoveredAsState (HoverInteraction.kt:64)");
        }
        ...
        composer.R();
        sy4 sy4Var = (sy4) A;
        composer.z(1930394772);
        boolean S = composer.S(eo3Var) | composer.S(sy4Var);
        Object A2 = composer.A();
        if (S || A2 == aVar.a()) {
            A2 = new HoverInteractionKt$collectIsHoveredAsState$1$1(eo3Var, sy4Var, null);
            composer.q(A2);
        }
        composer.R();
