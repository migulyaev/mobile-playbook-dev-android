...
public final class HijrahDate extends ChronoDateImpl<HijrahDate> implements Serializable {
    ...
    private static void parseLine(String str, int i) throws ParseException {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (indexOf == -1) {
                throw new ParseException("Offset has incorrect format at line " + i + InstructionFileId.DOT, i);
            }
            try {
                int parseInt = Integer.parseInt(nextToken.substring(indexOf + 1, nextToken.length()));
                int indexOf2 = nextToken.indexOf(45);
                if (indexOf2 == -1) {
                    throw new ParseException("Start and end year/month has incorrect format at line " + i + InstructionFileId.DOT, i);
                }
                ...
                if (indexOf3 == -1) {
                    throw new ParseException("Start year/month has incorrect format at line " + i + InstructionFileId.DOT, i);
                }
                ...
                try {
                    ...
                    try {
                        ...
                        if (indexOf4 == -1) {
                            throw new ParseException("End year/month has incorrect format at line " + i + InstructionFileId.DOT, i);
                        }
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (parseInt2 == -1 || parseInt3 == -1 || parseInt4 == -1 || parseInt5 == -1) {
                                    throw new ParseException("Unknown error at line " + i + InstructionFileId.DOT, i);
                                }
                                addDeviationAsHijrah(parseInt2, parseInt3, parseInt4, parseInt5, parseInt);
                            } catch (NumberFormatException unused) {
                                throw new ParseException("End month is not properly set at line " + i + InstructionFileId.DOT, i);
                            }
                        } catch (NumberFormatException unused2) {
                            throw new ParseException("End year is not properly set at line " + i + InstructionFileId.DOT, i);
                        }
                    } catch (NumberFormatException unused3) {
                        throw new ParseException("Start month is not properly set at line " + i + InstructionFileId.DOT, i);
                    }
                } catch (NumberFormatException unused4) {
                    throw new ParseException("Start year is not properly set at line " + i + InstructionFileId.DOT, i);
                }
            } catch (NumberFormatException unused5) {
                throw new ParseException("Offset is not properly set at line " + i + InstructionFileId.DOT, i);
            }
        }
    }
    ...
    /* JADX WARN: Type inference failed for: r5v10, types: [org.threeten.bp.chrono.HijrahDate] */
    /* JADX WARN: Type inference failed for: r5v11, types: [org.threeten.bp.chrono.HijrahDate] */
    /* JADX WARN: Type inference failed for: r5v12, types: [org.threeten.bp.chrono.HijrahDate] */
    /* JADX WARN: Type inference failed for: r5v14, types: [org.threeten.bp.chrono.HijrahDate] */
    /* JADX WARN: Type inference failed for: r5v7, types: [org.threeten.bp.chrono.HijrahDate] */
