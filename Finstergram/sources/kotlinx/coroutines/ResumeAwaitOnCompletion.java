...
public final class ResumeAwaitOnCompletion<T> extends JobNode {
    ...
    public void invoke2(Throwable cause) {
        ...
        if (state instanceof CompletedExceptionally) {
            ...
            cancellableContinuationImpl.resumeWith(Result.m37constructorimpl(ResultKt.createFailure(th)));
            return;
        }
        ...
        cancellableContinuationImpl2.resumeWith(Result.m37constructorimpl(unboxState));
    }
}
