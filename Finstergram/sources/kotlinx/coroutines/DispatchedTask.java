            ...
            try {
                ...
                try {
                    if (job != null && !job.isActive()) {
                        ...
                        continuation.resumeWith(Result.m37constructorimpl(ResultKt.createFailure(exception)));
                    } else {
                        T successfulResult$kotlinx_coroutines_core = getSuccessfulResult$kotlinx_coroutines_core(state);
                        Result.Companion companion3 = Result.INSTANCE;
                        continuation.resumeWith(Result.m37constructorimpl(successfulResult$kotlinx_coroutines_core));
                    }
                    ...
                    try {
                        ...
                        result = Result.m37constructorimpl(Unit.INSTANCE);
                    } catch (Throwable th3) {
                        th = th3;
                        Result.Companion companion5 = Result.INSTANCE;
                        result = Result.m37constructorimpl(ResultKt.createFailure(th));
                        handleFatalException(fatalException, Result.m40exceptionOrNullimpl(result));
                    }
                } catch (Throwable th4) {
                    th = th4;
                }
