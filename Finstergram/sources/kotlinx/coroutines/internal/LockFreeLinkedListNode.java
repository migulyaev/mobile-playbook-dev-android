...
public class LockFreeLinkedListNode {
    ...
    */
    ...
    public final boolean addLastIf(LockFreeLinkedListNode node, Function0<Boolean> condition) {
        CondAddOp condAdd = new LockFreeLinkedListNode$makeCondAddOp$1(condition, node);
        while (true) {
    ...
    public final /* synthetic */ Object removeFirstIfIsInstanceOfOrPeekIf(Function1 predicate) {
        ...
        while (true) {
            ...
            if ((((Boolean) predicate.invoke(first)).booleanValue() && !first.isRemoved()) || (next = first.removeOrNext()) == null) {
                return first;
            }
            next.helpRemovePrev();
        }
