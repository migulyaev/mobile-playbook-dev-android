...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public final boolean isReusable(CancellableContinuationImpl<?> requester) {
        Object value = this._reusableCancellableContinuation;
        if (value == null) {
            return false;
        }
        return !(value instanceof CancellableContinuationImpl) || value == requester;
    }
    ...
    public void resumeWith(Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(context)) {
            this._state = state;
            this.resumeMode = 0;
            this.dispatcher.mo1579dispatch(context, this);
            return;
        }
        if (DebugKt.getASSERTIONS_ENABLED()) {
        }
    ...
    */
    ...
    public final boolean resumeCancelled(Object state) {
        ...
        if (job != null && !job.isActive()) {
            ...
            resumeWith(Result.m37constructorimpl(ResultKt.createFailure(cause)));
            return true;
        }
        return false;
    }
