...
public final class InlineList<E> {
    ...
    public boolean equals(Object obj) {
        return m1572equalsimpl(getHolder(), obj);
    }

    public int hashCode() {
        return m1575hashCodeimpl(getHolder());
    }

    public String toString() {
        return m1577toStringimpl(getHolder());
    }
    ...
    public static final Object m1576plusFjFbRPM(Object arg0, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(e instanceof List))) {
            throw new AssertionError();
        }
        if (arg0 == null) {
            return m1570constructorimpl(e);
        }
        ...
        list.add(arg0);
        list.add(e);
        return m1570constructorimpl(list);
    }

    /* renamed from: forEachReversed-impl, reason: not valid java name */
    public static final void m1574forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
