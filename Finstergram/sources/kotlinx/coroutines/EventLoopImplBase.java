...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public final void mo1579dispatch(CoroutineContext context, Runnable block) {
        enqueue(block);
    }
    ...
    private final int scheduleImpl(long now, DelayedTask delayedTask) {
        ...
        if (delayedQueue == null) {
            ...
            AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_delayed$FU, $this$scheduleImpl_u24lambda_u2d7, null, new DelayedTaskQueue(now));
            DelayedTaskQueue delayedTaskQueue = (DelayedTaskQueue) $this$scheduleImpl_u24lambda_u2d7._delayed;
