    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Flow $this$collect$iv = this.$this_sample;
                this.label = 1;
                if ($this$collect$iv.collect(new FlowCollector<T>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1
                    @Override // kotlinx.coroutines.flow.FlowCollector
                    public Object emit(T t, Continuation<? super Unit> continuation) {
                        Object send = ProducerScope.this.send(t == null ? NullSurrogateKt.NULL : t, continuation);
