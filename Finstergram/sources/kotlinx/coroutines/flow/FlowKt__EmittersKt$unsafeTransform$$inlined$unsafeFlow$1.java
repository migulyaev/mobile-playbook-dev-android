...
public final class FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1<R> implements Flow<R> {
    ...
    public Object collect(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        ...
        Object collect = $this$collect$iv.collect(new FlowKt__EmittersKt$unsafeTransform$lambda1$$inlined$collect$1(this.$transform$inlined, flowCollector), continuation);
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        ...
        InlineMarker.mark(5);
        Flow $this$collect$iv = this.$this_unsafeTransform$inlined;
        FlowKt__EmittersKt$unsafeTransform$lambda1$$inlined$collect$1 flowKt__EmittersKt$unsafeTransform$lambda1$$inlined$collect$1 = new FlowKt__EmittersKt$unsafeTransform$lambda1$$inlined$collect$1(this.$transform$inlined, collector);
        InlineMarker.mark(0);
        $this$collect$iv.collect(flowKt__EmittersKt$unsafeTransform$lambda1$$inlined$collect$1, $completion);
        InlineMarker.mark(1);
