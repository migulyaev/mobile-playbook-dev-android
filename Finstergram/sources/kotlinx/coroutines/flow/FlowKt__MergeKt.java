    ...
    public static final <T> Flow<T> flattenConcat(final Flow<? extends Flow<? extends T>> flow) {
        return new Flow<T>() { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1
            ...
            public Object collect(final FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
                Flow $this$collect$iv = Flow.this;
                Object collect = $this$collect$iv.collect(new FlowCollector<Flow<? extends T>>() { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$flattenConcat$lambda-1$$inlined$collect$1
                    @Override // kotlinx.coroutines.flow.FlowCollector
                    public Object emit(Flow<? extends T> flow2, Continuation<? super Unit> continuation2) {
                        Flow<? extends T> value = flow2;
                        Object emitAll = FlowKt.emitAll(FlowCollector.this, value, continuation2);
