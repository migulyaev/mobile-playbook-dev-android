    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                if (holder instanceof ChannelResult.Failed) {
                    Throwable it = ChannelResult.m1544exceptionOrNullimpl(holder);
                    if (it != null) {
                        throw it;
                    }
                    if (objectRef.element != null) {
                        ...
                        this.L$1 = objectRef;
                        this.label = 1;
                        Object value = flowCollector.emit(value$iv, this);
            ...
            case 1:
                ...
                i = 0;
                flowKt__DelayKt$debounceInternal$1$3$22 = null;
                objectRef2 = (Ref.ObjectRef) flowKt__DelayKt$debounceInternal$1$3$2.L$1;
                ResultKt.throwOnFailure($result);
                objectRef = objectRef2;
                objectRef.element = NullSurrogateKt.DONE;
                return Unit.INSTANCE;
