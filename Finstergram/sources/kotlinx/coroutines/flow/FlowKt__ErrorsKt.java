...
public final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    /* renamed from: catch */
    public static final <T> Flow<T> m1565catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
    ...
    public static final <T> Flow<T> onErrorCollect(Flow<? extends T> flow, Flow<? extends T> flow2, Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m1558catch(flow, new FlowKt__ErrorsKt$onErrorCollect$2(function1, flow2, null));
    }
    ...
    public static final /* synthetic */ Flow retry(Flow $this$retry, int retries, Function1 predicate) {
        ...
        return FlowKt.retryWhen($this$retry, new FlowKt__ErrorsKt$retry$6(predicate, retries, null));
    }
    ...
    */
    public static final <T> java.lang.Object catchImpl(kotlinx.coroutines.flow.Flow<? extends T> r8, kotlinx.coroutines.flow.FlowCollector<? super T> r9, kotlin.coroutines.Continuation<? super java.lang.Throwable> r10) {
        /*
            boolean r0 = r10 instanceof kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$1
            if (r0 == 0) goto L14
            r0 = r10
