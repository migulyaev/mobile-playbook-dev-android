    ...
    */
    public final java.lang.Object onSubscription(kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        ...
        L32:
            ...
            kotlin.ResultKt.throwOnFailure(r0)     // Catch: java.lang.Throwable -> L80
            goto L62
        L40:
            kotlin.ResultKt.throwOnFailure(r0)
            r4 = r7
            kotlinx.coroutines.flow.FlowCollector<T> r2 = r4.collector
            r5 = 0
            ...
            r5.<init>(r2, r6)
            r2 = r5
            kotlin.jvm.functions.Function2<kotlinx.coroutines.flow.FlowCollector<? super T>, kotlin.coroutines.Continuation<? super kotlin.Unit>, java.lang.Object> r5 = r4.action     // Catch: java.lang.Throwable -> L80
            r8.L$0 = r4     // Catch: java.lang.Throwable -> L80
            r8.L$1 = r2     // Catch: java.lang.Throwable -> L80
            r6 = 1
            r8.label = r6     // Catch: java.lang.Throwable -> L80
            java.lang.Object r5 = r5.invoke(r2, r8)     // Catch: java.lang.Throwable -> L80
            if (r5 != r1) goto L62
            return r1
        L62:
            r2.releaseIntercepted()
            kotlinx.coroutines.flow.FlowCollector<T> r4 = r4.collector
            boolean r5 = r4 instanceof kotlinx.coroutines.flow.SubscribedFlowCollector
            if (r5 == 0) goto L7f
            kotlinx.coroutines.flow.SubscribedFlowCollector r4 = (kotlinx.coroutines.flow.SubscribedFlowCollector) r4
            r8.L$0 = r3
            r8.L$1 = r3
            r3 = 2
            r8.label = r3
            java.lang.Object r2 = r4.onSubscription(r8)
            if (r2 != r1) goto L7c
            return r1
        L7c:
