...
public final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1561debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt.debounce(flow, DelayKt.m1521toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$debounce$3
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final long invoke2(T t) {
                return DelayKt.m1521toDelayMillisLRDsOJo(function1.invoke(t).getRawValue());
            }
        });
    }
    ...
    public static final <T> Flow<T> m1562sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt.sample(flow, DelayKt.m1521toDelayMillisLRDsOJo(period));
    }
}
