...
public final class FlowKt__EmittersKt$onCompletion$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        /*
            r5 = this;
            boolean r0 = r7 instanceof kotlinx.coroutines.flow.FlowKt__EmittersKt$onCompletion$$inlined$unsafeFlow$1.AnonymousClass1
            if (r0 == 0) goto L14
            r0 = r7
        ...
        L4e:
            ...
            kotlinx.coroutines.flow.Flow r7 = r5.$this_onCompletion$inlined     // Catch: java.lang.Throwable -> L98
            r0.L$0 = r5     // Catch: java.lang.Throwable -> L98
            r0.L$1 = r6     // Catch: java.lang.Throwable -> L98
            r2 = 1
            r0.label = r2     // Catch: java.lang.Throwable -> L98
            java.lang.Object r7 = r7.collect(r6, r0)     // Catch: java.lang.Throwable -> L98
            if (r7 != r1) goto L65
            return r1
        L65:
            r2 = r5
        L66:
            ...
            r4.<init>(r6, r7)
            kotlin.jvm.functions.Function3 r6 = r2.$action$inlined     // Catch: java.lang.Throwable -> L92
            r0.L$0 = r4     // Catch: java.lang.Throwable -> L92
            r0.L$1 = r3     // Catch: java.lang.Throwable -> L92
            r7 = 3
            r0.label = r7     // Catch: java.lang.Throwable -> L92
            r7 = 6
            kotlin.jvm.internal.InlineMarker.mark(r7)     // Catch: java.lang.Throwable -> L92
            java.lang.Object r6 = r6.invoke(r4, r3, r0)     // Catch: java.lang.Throwable -> L92
            r7 = 7
            kotlin.jvm.internal.InlineMarker.mark(r7)     // Catch: java.lang.Throwable -> L92
            if (r6 != r1) goto L8a
            return r1
        ...
        L98:
            ...
            r2 = r5
        L9a:
            kotlinx.coroutines.flow.ThrowingCollector r7 = new kotlinx.coroutines.flow.ThrowingCollector
            r7.<init>(r6)
            ...
            r3 = 2
            r0.label = r3
            java.lang.Object r7 = kotlinx.coroutines.flow.FlowKt__EmittersKt.access$invokeSafely(r7, r2, r6, r0)
            if (r7 != r1) goto Lb1
            return r1
        Lb1:
            throw r6
