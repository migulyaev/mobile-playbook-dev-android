            ...
            synchronized (lock$iv) {
                ...
                if (workerCtl$FU.compareAndSet(this, -1, 1)) {
                    ...
                    if (lastIndex != oldIndex) {
                        Worker lastWorker = this_$iv.workers.get(lastIndex);
                        Intrinsics.checkNotNull(lastWorker);
