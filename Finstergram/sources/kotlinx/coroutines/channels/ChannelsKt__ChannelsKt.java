...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1550isSuccessimpl(sendChannel.mo1535trySendJP2dKIU(e))) {
            return;
        }
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) throws InterruptedException {
        Object $this$onSuccess$iv = sendChannel.mo1535trySendJP2dKIU(e);
        if (!($this$onSuccess$iv instanceof ChannelResult.Failed)) {
            return ChannelResult.INSTANCE.m1555successJP2dKIU(Unit.INSTANCE);
        }
        return ((ChannelResult) BuildersKt.runBlocking$default(null, new ChannelsKt__ChannelsKt$trySendBlocking$2(sendChannel, e, null), 1, null)).getHolder();
    }
}
