...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final java.lang.Object mo1533receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r8) {
        /*
            r7 = this;
        ...
        L32:
            ...
            if (r5 == 0) goto L50
            kotlinx.coroutines.channels.ChannelResult$Companion r5 = kotlinx.coroutines.channels.ChannelResult.INSTANCE
            r6 = r1
            kotlinx.coroutines.channels.Closed r6 = (kotlinx.coroutines.channels.Closed) r6
            java.lang.Throwable r6 = r6.closeCause
            java.lang.Object r5 = r5.m1553closedJP2dKIU(r6)
            goto L56
        L50:
            kotlinx.coroutines.channels.ChannelResult$Companion r5 = kotlinx.coroutines.channels.ChannelResult.INSTANCE
            java.lang.Object r5 = r5.m1555successJP2dKIU(r1)
        L56:
            return r5
        L57:
            r4 = 1
            r8.label = r4
            java.lang.Object r2 = r2.receiveSuspend(r4, r8)
            if (r2 != r1) goto L61
            return r1
        L61:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo1533receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public final Object mo1534tryReceivePtdJZtk() {
        Object result = pollInternal();
        return result == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1554failurePtdJZtk() : result instanceof Closed ? ChannelResult.INSTANCE.m1553closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.INSTANCE.m1555successJP2dKIU(result);
    }
    ...
    public void onCancelIdempotent(boolean wasClosed) {
        ...
        Object list = InlineList.m1571constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(previous instanceof LockFreeLinkedListHead)) {
                ...
                if (!previous.remove()) {
                    ...
                    list = InlineList.m1576plusFjFbRPM(list, (Send) previous);
                }
            } else {
                mo1532onCancelIdempotentListww6eGU(list, closed);
                return;
            }
        }
    }
    ...
    protected void mo1532onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int receiveMode, Object value) {
            ...
            switch (receiveMode) {
                ...
                case 1:
                    if (selectInstance.trySelect()) {
                        UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1540boximpl(ChannelResult.INSTANCE.m1553closedJP2dKIU(((Closed) value).closeCause)), selectInstance.getCompletion());
                        return;
                    }
                    return;
                default:
        ...
        if (receiveMode != 1) {
            ...
            Object $this$toResult$iv = ChannelResult.m1540boximpl(value instanceof Closed ? ChannelResult.INSTANCE.m1553closedJP2dKIU(((Closed) value).closeCause) : ChannelResult.INSTANCE.m1555successJP2dKIU(value));
            ...
            while (true) {
                ...
                if (result instanceof Closed) {
                    if (((Closed) result).closeCause == null) {
                        ...
                        cont.resumeWith(Result.m37constructorimpl(boxBoolean));
                    } else {
                        Throwable receiveException = ((Closed) result).getReceiveException();
                        Result.Companion companion2 = Result.INSTANCE;
                        cont.resumeWith(Result.m37constructorimpl(ResultKt.createFailure(receiveException)));
                    }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m1540boximpl(ChannelResult.INSTANCE.m1555successJP2dKIU(value)) : value;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m37constructorimpl(ResultKt.createFailure(receiveException)));
                return;
            }
            CancellableContinuation<Object> cancellableContinuation2 = this.cont;
            ChannelResult m1540boximpl = ChannelResult.m1540boximpl(ChannelResult.INSTANCE.m1553closedJP2dKIU(closed.closeCause));
            Result.Companion companion2 = Result.INSTANCE;
            cancellableContinuation2.resumeWith(Result.m37constructorimpl(m1540boximpl));
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E value) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1540boximpl(ChannelResult.INSTANCE.m1555successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
            ...
            if (this.select.trySelect()) {
                switch (this.receiveMode) {
                    case 0:
                        ...
                        return;
                    case 1:
                        CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1540boximpl(ChannelResult.INSTANCE.m1553closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                        return;
                    default:
                        return;
                }
