...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m37constructorimpl = Result.m37constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m37constructorimpl = Result.m37constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m43isFailureimpl(m37constructorimpl) ? null : m37constructorimpl);
