...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    public void mo1580scheduleResumeAfterDelay(long timeMillis, final CancellableContinuation<? super Unit> continuation) {
        ...
        this.handler.postDelayed(block, RangesKt.coerceAtMost(timeMillis, DurationKt.MAX_MILLIS));
    ...
    public String toString() {
        ...
        if (stringInternalImpl == null) {
            HandlerContext $this$toString_u24lambda_u2d3 = this;
            String str = $this$toString_u24lambda_u2d3.name;
            if (str == null) {
                str = $this$toString_u24lambda_u2d3.handler.toString();
            }
            return $this$toString_u24lambda_u2d3.invokeImmediately ? Intrinsics.stringPlus(str, ".immediate") : str;
        }
