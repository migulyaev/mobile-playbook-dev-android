...
public abstract class MapLikeSerializer<Key, Value, Collection, Builder extends Map<Key, Value>> extends AbstractCollectionSerializer<Map.Entry<? extends Key, ? extends Value>, Collection, Builder> {
    ...
    public void serialize(Encoder encoder, Collection value) {
        ...
        while (iterator.hasNext()) {
            ...
            Key key = $dstr$k$v.getKey();
            Value value2 = $dstr$k$v.getValue();
            int index2 = index + 1;
            composite.encodeSerializableElement(getDescriptor(), index, getKeySerializer(), key);
            index = index2 + 1;
            composite.encodeSerializableElement(getDescriptor(), index2, getValueSerializer(), value2);
        }
