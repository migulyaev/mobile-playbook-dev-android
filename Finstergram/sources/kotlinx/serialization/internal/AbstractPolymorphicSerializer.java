...
public abstract class AbstractPolymorphicSerializer<T> implements KSerializer<T> {
    ...
    public final void serialize(Encoder encoder, T value) {
        ...
        try {
            ...
            composite$iv.encodeSerializableElement(getDescriptor(), 1, actualSerializer, value);
    ...
    public final T deserialize(Decoder decoder) {
        ...
        try {
            ...
            if (beginStructure.decodeSequentially()) {
                T decodeSequentially = abstractPolymorphicSerializer.decodeSequentially(beginStructure);
            ...
            while (true) {
                ...
                switch (decodeElementIndex) {
                    case -1:
                        ...
                        if (t == null) {
                            throw new IllegalArgumentException(Intrinsics.stringPlus("Polymorphic value has not been read for class ", objectRef2.element).toString());
                        }
                        beginStructure.endStructure(descriptor);
                        return t;
                    case 0:
                        Ref.ObjectRef objectRef3 = objectRef;
                        objectRef3.element = (T) beginStructure.decodeStringElement(getDescriptor(), decodeElementIndex);
                    ...
                    case 1:
                        ...
                        t = CompositeDecoder.DefaultImpls.decodeSerializableElement$default(beginStructure, getDescriptor(), decodeElementIndex, PolymorphicSerializerKt.findPolymorphicSerializer(abstractPolymorphicSerializer, beginStructure, (String) objectRef.element), null, 8, null);
                        objectRef = objectRef;
                        abstractPolymorphicSerializer = this;
                        break;
                    default:
