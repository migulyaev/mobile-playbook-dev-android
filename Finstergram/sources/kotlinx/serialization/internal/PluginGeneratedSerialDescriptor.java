...
public class PluginGeneratedSerialDescriptor implements SerialDescriptor, CachedNames {
    ...
    public PluginGeneratedSerialDescriptor(String serialName, GeneratedSerializer<?> generatedSerializer, int elementsCount) {
        ...
        this.propertiesAnnotations = new List[i2];
        this.elementsOptionality = new boolean[i2];
    ...
    private final Map<String, Integer> buildIndices() {
        ...
        if (length >= 0) {
            ...
            do {
                int i2 = i;
                i++;
                indices.put(this.names[i2], Integer.valueOf(i2));
            } while (i <= length);
        }
        return indices;
    }
    ...
    public String toString() {
        return CollectionsKt.joinToString$default(RangesKt.until(0, this.elementsCount), ", ", Intrinsics.stringPlus(getSerialName(), "("), ")", 0, null, new Function1<Integer, CharSequence>() { // from class: kotlinx.serialization.internal.PluginGeneratedSerialDescriptor$toString$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
