...
public final class ElementMarker {
    ...
    /* compiled from: ElementMarker.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0016\n\u0000\b\u0082\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Lkotlinx/serialization/internal/ElementMarker$Companion;", "", "()V", "EMPTY_HIGH_MARKS", "", "kotlinx-serialization-core"}, k = 1, mv = {1, 5, 1}, xi = 48)
    /* loaded from: classes.dex */
    ...
    public final int nextUnmarkedIndex() {
        ...
        do {
            ...
            if (j != -1) {
                index = Long.numberOfTrailingZeros(~j);
                this.lowerMarks |= 1 << index;
            } else {
                if (elementsCount > 64) {
        ...
        } while (!this.readIfAbsent.invoke(this.descriptor, Integer.valueOf(index)).booleanValue());
        return index;
    }
    ...
    private final void markHigh(int index) {
        ...
        jArr[slot] = jArr[slot] | (1 << offsetInSlot);
    }

    private final int nextUnmarkedHighIndex() {
        int length = this.highMarksArray.length - 1;
        if (length >= 0) {
            int i = 0;
            do {
                int slot = i;
