...
public final class EnumDescriptor extends PluginGeneratedSerialDescriptor {
        ...
        this.elementDescriptors = LazyKt.lazy(new Function0<SerialDescriptor[]>() { // from class: kotlinx.serialization.internal.EnumDescriptor$elementDescriptors$2
            ...
            public final SerialDescriptor[] invoke() {
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    serialDescriptorArr[i2] = SerialDescriptorsKt.buildSerialDescriptor$default(name + '.' + this.getElementName(i2), StructureKind.OBJECT.INSTANCE, new SerialDescriptor[0], null, 8, null);
                }
    ...
    public String toString() {
        return CollectionsKt.joinToString$default(SerialDescriptorKt.getElementNames(this), ", ", Intrinsics.stringPlus(getSerialName(), "("), ")", 0, null, null, 56, null);
    }
