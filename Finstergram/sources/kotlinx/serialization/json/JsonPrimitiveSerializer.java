...
public final class JsonPrimitiveSerializer implements KSerializer<JsonPrimitive> {
    ...
    public JsonPrimitive deserialize(Decoder decoder) {
        ...
        if (!(result instanceof JsonPrimitive)) {
            throw JsonExceptionsKt.JsonDecodingException(-1, Intrinsics.stringPlus("Unexpected JSON element, expected JsonPrimitive, had ", Reflection.getOrCreateKotlinClass(result.getClass())), result.toString());
        }
