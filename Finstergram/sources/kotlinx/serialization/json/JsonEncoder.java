...
public interface JsonEncoder extends Encoder, CompositeEncoder {
    ...
    public static final class DefaultImpls {
        public static CompositeEncoder beginCollection(JsonEncoder jsonEncoder, SerialDescriptor descriptor, int collectionSize) {
            Intrinsics.checkNotNullParameter(jsonEncoder, "this");
            Intrinsics.checkNotNullParameter(descriptor, "descriptor");
            return Encoder.DefaultImpls.beginCollection(jsonEncoder, descriptor, collectionSize);
        }
        ...
        @ExperimentalSerializationApi
        public static boolean shouldEncodeElementDefault(JsonEncoder jsonEncoder, SerialDescriptor descriptor, int index) {
            Intrinsics.checkNotNullParameter(jsonEncoder, "this");
            Intrinsics.checkNotNullParameter(descriptor, "descriptor");
            return CompositeEncoder.DefaultImpls.shouldEncodeElementDefault(jsonEncoder, descriptor, index);
        }
    }
}
