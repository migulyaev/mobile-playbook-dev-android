...
public final class JsonDecoderForUnsignedTypes extends AbstractDecoder {
    ...
    public int decodeInt() {
        ...
        try {
            ...
            JsonReader.fail$default($this$parseString$iv, "Failed to parse type 'UInt' for input '" + input$iv + '\'', 0, 2, null);
    ...
    public long decodeLong() {
        ...
        try {
            ...
            JsonReader.fail$default($this$parseString$iv, "Failed to parse type 'ULong' for input '" + input$iv + '\'', 0, 2, null);
            throw new KotlinNothingValueException();
        }
    }
    ...
    public byte decodeByte() {
        ...
        try {
            ...
            JsonReader.fail$default($this$parseString$iv, "Failed to parse type 'UByte' for input '" + input$iv + '\'', 0, 2, null);
            throw new KotlinNothingValueException();
        }
    }
    ...
    public short decodeShort() {
        ...
        try {
            ...
            JsonReader.fail$default($this$parseString$iv, "Failed to parse type 'UShort' for input '" + input$iv + '\'', 0, 2, null);
            throw new KotlinNothingValueException();
        }
    }
}
