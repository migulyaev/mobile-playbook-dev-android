...
public final class JsonExceptionsKt {
    ...
    private static final CharSequence minify(CharSequence $this$minify, int offset) {
        if ($this$minify.length() < 200) {
            return $this$minify;
        }
        if (offset == -1) {
            int start = $this$minify.length() - 60;
            return start <= 0 ? $this$minify : Intrinsics.stringPlus(".....", $this$minify.subSequence(start, $this$minify.length()).toString());
        }
