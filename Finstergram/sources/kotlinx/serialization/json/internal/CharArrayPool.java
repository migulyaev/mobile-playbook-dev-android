...
@Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0019\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\bÀ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\u0007J\u0006\u0010\f\u001a\u00020\u0007R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\r"}, d2 = {"Lkotlinx/serialization/json/internal/CharArrayPool;", "", "()V", "MAX_CHARS_IN_POOL", "", "arrays", "Lkotlin/collections/ArrayDeque;", "", "charsTotal", BuildConfig.BUILD_TYPE, "", "array", "take", "kotlinx-serialization-json"}, k = 1, mv = {1, 5, 1}, xi = 48)
...
public final class CharArrayPool {
    ...
    static {
        ...
        try {
            ...
            m37constructorimpl = Result.m37constructorimpl(StringsKt.toIntOrNull(property));
        } catch (Throwable th) {
    ...
    public final char[] take() {
        char[] it;
        synchronized (this) {
            it = arrays.removeLastOrNull();
            if (it == null) {
                it = null;
            } else {
                charsTotal -= it.length;
            }
        }
        char[] candidate = it;
        return candidate == null ? new char[128] : candidate;
    }
