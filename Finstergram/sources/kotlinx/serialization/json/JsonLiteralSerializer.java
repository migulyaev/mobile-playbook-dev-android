...
public final class JsonLiteralSerializer implements KSerializer<JsonLiteral> {
    ...
    public void serialize(Encoder encoder, JsonLiteral value) {
        ...
        if (booleanOrNull != null) {
            boolean it4 = booleanOrNull.booleanValue();
    ...
    public JsonLiteral deserialize(Decoder decoder) {
        ...
        if (!(result instanceof JsonLiteral)) {
            throw JsonExceptionsKt.JsonDecodingException(-1, Intrinsics.stringPlus("Unexpected JSON element, expected JsonLiteral, had ", Reflection.getOrCreateKotlinClass(result.getClass())), result.toString());
        }
