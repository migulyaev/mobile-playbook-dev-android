...
public final class JsonObject extends JsonElement implements Map<String, JsonElement>, KMappedMarker {
    ...
    @Override // java.util.Map
    public final /* bridge */ JsonElement get(Object key) {
        if (key instanceof String) {
    ...
    public String toString() {
        return CollectionsKt.joinToString$default(this.content.entrySet(), ",", "{", "}", 0, null, new Function1<Map.Entry<? extends String, ? extends JsonElement>, CharSequence>() { // from class: kotlinx.serialization.json.JsonObject$toString$1
            ...
            public final CharSequence invoke2(Map.Entry<String, ? extends JsonElement> dstr$k$v) {
                ...
                String k = dstr$k$v.getKey();
                JsonElement v = dstr$k$v.getValue();
                StringBuilder $this$invoke_u24lambda_u2d0 = new StringBuilder();
                StringOpsKt.printQuoted($this$invoke_u24lambda_u2d0, k);
                $this$invoke_u24lambda_u2d0.append(AbstractJsonLexerKt.COLON);
                $this$invoke_u24lambda_u2d0.append(v);
                String sb = $this$invoke_u24lambda_u2d0.toString();
