...
public final class JsonElementSerializersKt {
    ...
    public static final JsonDecoder asJsonDecoder(Decoder $this$asJsonDecoder) {
        ...
        if (jsonDecoder == null) {
            throw new IllegalStateException(Intrinsics.stringPlus("This serializer can be used only with Json format.Expected Decoder to be JsonDecoder, got ", Reflection.getOrCreateKotlinClass($this$asJsonDecoder.getClass())));
        }
        return jsonDecoder;
    }
    ...
    public static final JsonEncoder asJsonEncoder(Encoder $this$asJsonEncoder) {
        ...
        if (jsonEncoder == null) {
            throw new IllegalStateException(Intrinsics.stringPlus("This serializer can be used only with Json format.Expected Encoder to be JsonEncoder, got ", Reflection.getOrCreateKotlinClass($this$asJsonEncoder.getClass())));
        }
        return jsonEncoder;
    }
