...
public final class SerialDescriptorImpl implements SerialDescriptor, CachedNames {
    ...
    public SerialDescriptorImpl(String serialName, SerialKind kind, int elementsCount, List<? extends SerialDescriptor> typeParameters, ClassSerialDescriptorBuilder builder) {
        ...
        if (array != null) {
            ...
            Object[] array2 = $this$toTypedArray$iv2.toArray(new List[0]);
            if (array2 != null) {
                ...
                Iterable $this$map$iv = ArraysKt.withIndex(strArr);
    ...
    public String toString() {
        return CollectionsKt.joinToString$default(RangesKt.until(0, getElementsCount()), ", ", Intrinsics.stringPlus(getSerialName(), "("), ")", 0, null, new Function1<Integer, CharSequence>() { // from class: kotlinx.serialization.descriptors.SerialDescriptorImpl$toString$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public final CharSequence invoke(int it) {
                return SerialDescriptorImpl.this.getElementName(it) + ": " + SerialDescriptorImpl.this.getElementDescriptor(it).getSerialName();
            }
        }, 24, null);
    }
}
