...
public interface Encoder {
    ...
    Encoder encodeInline(SerialDescriptor inlineDescriptor);
    ...
    public static final class DefaultImpls {
        ...
        public static CompositeEncoder beginCollection(Encoder encoder, SerialDescriptor descriptor, int collectionSize) {
            Intrinsics.checkNotNullParameter(encoder, "this");
