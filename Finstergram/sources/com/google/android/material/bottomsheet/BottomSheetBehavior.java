                ...
                if (yvel < 0.0f) {
                    if (BottomSheetBehavior.this.fitToContents) {
                        ...
                        if (BottomSheetBehavior.this.shouldSkipHalfExpandedStateWhenDragging()) {
                            ...
                            int top3 = BottomSheetBehavior.this.halfExpandedOffset;
                            top = top3;
                            targetState = 6;
                        } else {
                            int top4 = BottomSheetBehavior.this.getExpandedOffset();
                            top = top4;
                            targetState = 3;
                        }
                    }
                    ...
                    if ((Math.abs(xvel) >= Math.abs(yvel) || yvel <= 500.0f) && !releasedLow(releasedChild)) {
                        if (BottomSheetBehavior.this.fitToContents) {
                            ...
                            if (Math.abs(top5 - BottomSheetBehavior.this.getExpandedOffset()) < Math.abs(releasedChild.getTop() - BottomSheetBehavior.this.halfExpandedOffset)) {
                    ...
                    if (BottomSheetBehavior.this.fitToContents) {
                        if (Math.abs(currentTop3 - BottomSheetBehavior.this.fitToContentsOffset) < Math.abs(currentTop3 - BottomSheetBehavior.this.collapsedOffset)) {
                            int top9 = BottomSheetBehavior.this.fitToContentsOffset;
                            top = top9;
                            targetState = 3;
                        } else {
                        ...
                        if (currentTop3 < Math.abs(currentTop3 - BottomSheetBehavior.this.collapsedOffset)) {
                            int top11 = BottomSheetBehavior.this.getExpandedOffset();
                            top = top11;
                            targetState = 3;
                            ...
                            int top13 = BottomSheetBehavior.this.halfExpandedOffset;
                            top = top13;
                            targetState = 6;
                        }
                        ...
                        if (BottomSheetBehavior.this.shouldSkipHalfExpandedStateWhenDragging()) {
                            int top14 = BottomSheetBehavior.this.collapsedOffset;
                            top = top14;
                            targetState = 4;
                        } else {
                            int top15 = BottomSheetBehavior.this.halfExpandedOffset;
                            top = top15;
                            targetState = 6;
                        }
                    } else {
                        int top16 = BottomSheetBehavior.this.collapsedOffset;
                        top = top16;
                        targetState = 4;
                    }
                }
            ...
            if (top4 == 0) {
                ...
                if (this.fitToContents) {
                    ...
                    if (currentTop2 < top7) {
                        ...
                        int top11 = this.halfExpandedOffset;
                        currentTop = top11;
                        top = 6;
                    } else {
                        int top12 = this.collapsedOffset;
                        currentTop = top12;
                        top = 4;
                    }
                }
                ...
                if (Math.abs(currentTop3 - this.halfExpandedOffset) < Math.abs(currentTop3 - this.collapsedOffset)) {
                    int top13 = this.halfExpandedOffset;
                    currentTop = top13;
                    top = 6;
                } else {
                    int top14 = this.collapsedOffset;
                    currentTop = top14;
                    top = 4;
                }
            }
