...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0014\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\u001a\u001c\u0010\u0000\u001a\u00020\u00012\n\b\u0002\u0010\u0002\u001a\u0004\u0018\u00010\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u0005¨\u0006\u0006"}, d2 = {"ActivityNavigatorExtras", "Landroidx/navigation/ActivityNavigator$Extras;", "activityOptions", "Landroidx/core/app/ActivityOptionsCompat;", "flags", "", "navigation-runtime-ktx_release"}, k = 2, mv = {1, 1, 13})
...
public final class ActivityNavigatorExtrasKt {
    ...
    public static final ActivityNavigator.Extras ActivityNavigatorExtras(ActivityOptionsCompat activityOptions, int flags) {
        ActivityNavigator.Extras.Builder $receiver = new ActivityNavigator.Extras.Builder();
        if (activityOptions != null) {
            $receiver.setActivityOptions(activityOptions);
        }
        $receiver.addFlags(flags);
        ActivityNavigator.Extras build = $receiver.build();
