...
public class NavDestination {
    ...
    public static <C> Class<? extends C> parseClassFromName(Context context, String name, Class<? extends C> cls) {
        if (name.charAt(0) == '.') {
        ...
        if (!cls.isAssignableFrom(clazz)) {
            throw new IllegalArgumentException(name + " must be a subclass of " + cls);
        }
        return clazz;
    }
