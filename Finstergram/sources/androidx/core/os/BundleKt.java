        ...
        while (i < length) {
            ...
            if (value == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    ...
                    throw new IllegalArgumentException("Illegal value array type " + ((Object) valueType) + " for key \"" + key + '\"');
                }
                ...
                throw new IllegalArgumentException("Illegal value type " + ((Object) valueType2) + " for key \"" + key + '\"');
            }
        }
