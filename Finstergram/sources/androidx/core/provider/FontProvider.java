        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    result.add(FontsContractCompat.FontInfo.create(fileUri, ttcIndex2, weight2, (italicColumnIndex == -1 || cursor.getInt(italicColumnIndex) != ttcIndex) ? 0 : ttcIndex, resultCode));
