...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1251getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m209constructorimpl = ((int) ULong.m209constructorimpl(j ^ ULong.m209constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m209constructorimpl2 = (m209constructorimpl + ((int) ULong.m209constructorimpl(j2 ^ ULong.m209constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return m209constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m254toStringimpl(this.first)).append("..").append((Object) ULong.m254toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m254toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m254toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
