...
public final class TestTimeSource extends AbstractLongTimeSource {
    ...
    public final void m1492plusAssignLRDsOJo(long duration) {
        long newReading;
        ...
        if (longDelta != Long.MIN_VALUE && longDelta != Long.MAX_VALUE) {
            ...
            if ((j ^ longDelta) >= 0 && (j ^ newReading) < 0) {
                m1491overflowLRDsOJo(duration);
            }
        } else {
            double delta = Duration.m1401toDoubleimpl(duration, getUnit());
    ...
    private final void m1491overflowLRDsOJo(long duration) {
