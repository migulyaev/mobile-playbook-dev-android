...
public abstract class AbstractDoubleTimeSource implements TimeSource {
    ...
    private static final class DoubleTimeMark implements TimeMark {
        ...
        public TimeMark mo1351minusLRDsOJo(long duration) {
            return TimeMark.DefaultImpls.m1493minusLRDsOJo(this, duration);
        }
        ...
        public TimeMark mo1352plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1394plusLRDsOJo(this.offset, duration), null);
        }
    }

    @Override // kotlin.time.TimeSource
    public TimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1460getZEROUwyO8pc(), null);
    }
}
