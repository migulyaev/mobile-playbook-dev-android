...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1510copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1512copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m1512copyRFiDyg4(T value, long duration) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1407toStringimpl(this.duration)) + ')';
    }
    ...
    public final long m1513getDurationUwyO8pc() {
        return this.duration;
    }
